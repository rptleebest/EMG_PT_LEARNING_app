...
VIRTUAL_REPORTS = {
    "오른쪽 손목굴증후군 의심": {
        ...
        "interpretation": {
            ...
            "motor": [
                ...
                "오른쪽 정중신경 복합근육활동전위(CMAP) 진폭도 정상측보다 낮아 단순 말이집탈락성 지연뿐 아니라 운동축삭 손상 가능성이 동반됩니다.",
                "자신경 운동반응은 보존되어 있어 C8-T1 신경뿌리병증이나 하부위팔신경얼기 병변보다는 정중신경 단일신경병증에 더 부합합니다.",
            ],
            "emg": [
                "짧은엄지벌림근에서 휴식 시 자발활동전위(fibrillation potential)와 양성예파(positive sharp wave)가 관찰되어 정중신경 지배 근육의 활동성 탈신경을 시사합니다.",
            ...
            "differential": [
                ...
                "아래 위팔신경얼기병증: 정중신경뿐 아니라 자신경, 안쪽아래팔피부신경 등의 이상이 함께 나타날 수 있습니다.",
            ],
            "additional": [
    ...
    "왼쪽 C6 신경뿌리병증 의심": {
        ...
        "interpretation": {
            "sensory": [
                ...
                "환자는 엄지와 검지 저림을 호소다리만  감각신경활동전위(SNAP)가 보존되어 있으므로 병변이 말초 감각신경 자체보다 뒤뿌리신경절보다 몸쪽, 즉 신경뿌리 수준일 가능성이 커집니다.",
            ],
            "motor": [
                "운동신경전도검사에서 먼쪽(distal) 말초신경의 뚜렷한 전도차단이나 원위잠복기 지연이 관찰되지 않습니다.",
            ...
            "differential": [
                "손목굴증후군: 정중신경  감각신경활동전위(SNAP)와 복합근육활동전위(CMAP)의 손목 부위 지연이 주로 관찰됩니다.",
                "노신경병증: 노신경 지배 근육과 노신경 감각분지 이상이 함께 나타날 수 있으나 목 척추주위근 이상은 일반적으로 설명하기 어렵습니다.",
                "위팔신경얼기병증: 감각신경활동전위 감소가 동반될 수 있으며, 목 척추주위근은 보존되는 경우가 많습니다.",
            ],
            "additional": [
                "목 MRI로 C5-6 또는 C6 신경뿌리 압박 여부를 확인합니다.",
                "Spurling test, 목 신경학적 검사, 팔 근력·반사 평가를 함께 시행합니다.",
            ],
        },
    },
    ...
    "오른쪽 온종아리신경병증 의심": {
        ...
        "interpretation": {
            "sensory": [
                "오른쪽 얕은종아리신경  감각신경활동전위(SNAP) 진폭이 정상측보다 크게 감소해 종아리신경 감각섬유 침범을 시사합니다.",
                "장딴지신경  감각신경활동전위(SNAP)는 보존되어 있어 더 광범위한 좌골신경병증이나 다발신경병증보다는 종아리신경 영역의 국소 병변에 가깝습니다.",
            ],
            "motor": [
                "종아리신경 운동검사에서 종아리뼈머리 위 자극 시 복합근육활동전위(CMAP) 진폭이 종아리뼈머리 아래 자극보다 현저히 감소합니다.",
            ...
            "differential": [
                "L5 신경뿌리병증: 얕은종아리신경  감각신경활동전위(SNAP)가 보존되는 경우가 많고, 허리 척추주위근 또는 중간볼기근 이상이 동반될 수 있습니다.",
                "좌골신경병증: 종아리신경뿐 아니라 정강신경 지배 근육도 침범될 수 있습니다.",
                "길이의존성 다발신경병증: 양측성, 대칭성, 먼쪽(distal) 감각신경 감소가 흔합니다.",
            ],
            "additional": [
    ...
    "왼쪽 L5 신경뿌리병증 의심": {
        ...
        "interpretation": {
            "sensory": [
                "얕은종아리신경과 장딴지신경  감각신경활동전위(SNAP)가 보존되어 있습니다.",
                "발등 저림이 있어도 감각신경활동전위가 보존되면 병변이 말초 감각신경 먼쪽(distal)보다 뒤뿌리신경절보다 몸쪽에 있을 가능성을 고려합니다.",
            ],
            "motor": [
                "종아리신경 운동검사에서 종아리뼈머리 부위 전도차단이 뚜렷다리 않습니다.",
            ...
            "differential": [
                "온종아리신경병증: 얕은종아리신경  감각신경활동전위(SNAP) 감소와 종아리뼈머리 부위 전도차단이 흔합니다.",
                "좌골신경병증: 종아리신경과 정강신경 지배 근육이 함께 침범될 수 있습니다.",
                "말초 다발신경병증: 양측성 감각신경 진폭 감소가 흔합니다.",
            ],
            "additional": [
                "허리 MRI로 L4-5 또는 L5-S1 추간판 탈출과 L5 신경뿌리 압박 여부를 확인합니다.",
                "SLR test, 다리 근력검사, 감각검사, 보행분석을 함께 시행합니다.",
            ],
        },
    },
    ...
    "축삭성 다발신경병증 의심": {
        "meta": {
            ...
            "clinical_hint": "양측 먼쪽(distal) 감각신경과 운동신경 진폭 감소를 통해 길이의존성 축삭 손상을 해석하는 사례입니다.",
        },
        "diagnosis": "길이의존성 축삭성 감각운동 다발신경병증(Length-dependent axonal sensorimotor polyneuropathy)",
        "lesion": "양측 다리 먼쪽(distal) 말초신경 축삭, 긴 신경부터 우세하게 침범",
        "sensory_ncs": [
            {
                "nerve": "장딴지신경 감각신경활동전위(Sural SNAP)",
                "recording": "가쪽 발목",
        ...
        "interpretation": {
            "sensory": [
                "양측 장딴지신경  감각신경활동전위(SNAP)가 반응 소실되어 다리 먼쪽(distal) 감각축삭 손상이 뚜렷합니다.",
                "얕은종아리신경 감각반응도 낮지만, 팔 정중신경 감각반응은 상대적으로 보존되어 있습니다.",
                "이는 신경 길이가 긴 다리 먼쪽(distal)부터 손상되는 길이의존성 양상과 잘 맞습니다.",
            ],
            "motor": [
                "정강신경과 종아리신경 복합근육활동전위(CMAP) 진폭이 낮아 운동축삭 침범이 동반됩니다.",
                "전도속도 저하가 일부 있지만, 핵심은 광범위한 진폭 감소이므로 축삭성 다발신경병증으로 해석하는 것이 적절합니다.",
            ],
            "emg": [
                "원위 다리 근육에서 탈신경 소견이 관찰되며, 근위 다리와 팔 근육은 상대적으로 보존됩니다.",
                "이러한 먼쪽(distal) 우세 양상은 dying-back 형태의 길이의존성 축삭 손상과 부합합니다.",
            ],
            "integration": [
                "양측성, 대칭성, 먼쪽(distal) 우세 감각·운동 진폭 감소와 원위 다리 침근전도 이상을 종합하면 길이의존성 축삭성 감각운동 다발신경병증이 가장 타당합니다.",
                "당뇨병, 신장질환, 알코올, 영양결핍, 약물성 신경병증 등을 원인으로 감별해야 합니다.",
            ],
            "differential": [
                "허리 신경뿌리병증: 특정 분절 근육과 척추주위근 이상이 두드러지며 감각신경활동전위는 보존될 수 있습니다.",
                "단일 말초신경병증: 한 신경 영역에 국한된 전도 이상이 주로 나타납니다.",
                "말이집탈락성 다발신경병증: 전도속도 저하, 원위잠복기 지연, 전도차단이 더 두드러집니다.",
            ],
            "additional": [
                "혈당(당화혈색소, HbA1c), 비타민 B12, 갑상샘기능, 신장기능, 약물력, 음주력 평가가 필요합니다.",
    ...
    "급성 말이집탈락성 다발신경뿌리병증 의심": {
        "meta": {
            ...
            "clinical_hint": "전도속도 저하, 원위잠복기 지연, F파 이상을 통해 말이집탈락성 다발신경뿌리병증을 해석하는 사례입니다.",
        },
        ...
        "interpretation": {
            "sensory": [
                "팔 감각신경에서 잠복기 지연과 전도속도 저하가 관찰되지만, 장딴지신경은 상대적으로 보존되어 있습니다.",
                "이러한 장딴지 신경 보존(sural sparing) 양상은 급성 말이집탈락성 다발신경뿌리병증에서 교육적으로 중요한 단서가 될 수 있습니다.",
            ],
            "motor": [
            ...
            "emg": [
                "침근전도에서 휴식 시 비정상 자발전위가 뚜렷다리 않을 수 있습니다.",
                "수의수축 시 운동단위동원 감소는 실제 수축에 참여하는 운동단위가 줄어든 결과로 해석할 수 있습니다.",
            ],
            "integration": [
                "급성 상행성 근력저하, 반사 저하, 다발 운동신경의 말이집탈락성 전도 이상, F파 소실을 종합하면 급성염증성 말이집탈락성 다발성신경병증(AIDP) 또는 기얭-바레증후군 스펙트럼(Guillain-Barre syndrome spectrum)을 의심해야 합니다.",
                "F파 소실은 몸쪽(proximal) 신경뿌리 전도 이상이 있음을 시사합니다.",
            ],
            "differential": [
...
# =============================================================================
# 추가 가상 결과표 4개: 총 10개 복구용
# =============================================================================

VIRTUAL_REPORTS.update(
    {
        "오른쪽 팔꿈치굴증후군 의심": {
            "meta": {
                "age": 49,
                "sex": "남성",
                "side": "오른쪽",
                "chief": "오른쪽 새끼손가락과 약지 자쪽 저림. 팔꿈치를 오래 굽히면 증상 악화. 손가락 벌림 약화 동반.",
                "clinical_hint": "자신경 감각반응 감소와 팔꿈치 구간 운동전도 저하를 통해 자신경 포착 위치를 해석하는 사례입니다.",
            },
            "diagnosis": "오른쪽 팔꿈치굴증후군, 팔꿈치 부위 자신경병증(Ulnar neuropathy at the elbow)",
            "lesion": "오른쪽 팔꿈치굴 또는 팔꿈치 주변 자신경",
            "sensory_ncs": [
                {
                    "nerve": "자신경 감각신경활동전위(Ulnar SNAP)",
                    "recording": "새끼손가락",
            ...
            "interpretation": {
                "sensory": [
                    "오른쪽 자신경  감각신경활동전위(SNAP) 진폭이 정상측보다 뚜렷하게 감소하여 자신경 감각섬유 침범을 시사합니다.",
                    "정중신경 감각신경활동전위(SNAP)는 보존되어 있어 손 전체 다발신경병증보다는 자신경 단일신경병증 가능성이 큽니다.",
                ],
                "motor": [
                    "자신경 운동전도에서 팔꿈치 아래 자극과 팔꿈치 위 자극 사이에 진폭 감소와 전도속도 저하가 나타납니다.",
                    "이는 팔꿈치 구간에서 국소 전도차단 또는 말이집탈락성 포착이 있음을 시사합니다.",
                ],
                "emg": [
                    "자신경 지배 근육인 첫째등쪽뼈사이근(FDI)과 짧은엄지벌림근(APB)에서 탈신경 소견과 운동단위 동원감소가 관찰됩니다.",
                    "정중신경 지배 짧은엄지벌림근(APB)과 목 척추주위근은 정상으로, C8-T1 신경뿌리병증 가능성은 낮아집니다.",
                ],
                "integration": [
                    "자쪽 손가락 저림, 자신경 감각반응 감소, 팔꿈치 구간 운동전도 저하, 자신경 지배 손근육 탈신경을 종합하면 오른쪽 팔꿈치굴증후군이 가장 타당합니다.",
                    "병변 위치는 손목이 아니라 팔꿈치 주변 자신경으로 추정됩니다.",
                ],
                "differential": [
                    "C8-T1 신경뿌리병증:  감각신경활동전위(SNAP)가 보존되는 경우가 많고, 목 척추주위근 이상이 동반될 수 있습니다.",
                    "하부위팔신경얼기병증: 자신경뿐 아니라 정중신경 일부와 안쪽아래팔피부신경 이상이 함께 나타날 수 있습니다.",
                    "손목 부위 자신경병증: 팔꿈치 구간 전도 저하 없이 손목 이하 자신경 지배 근육 위주로 이상이 나타납니다.",
                ],
                "additional": [
                    "팔꿈치 굴곡 자세 제한, 야간 팔꿈치 보조기, 작업 자세 교정이 필요합니다.",
                    "신경초음파로 팔꿈치 부위 자신경 비후나 탈구 여부를 확인할 수 있습니다.",
                ],
            },
        },
        ...
        "왼쪽 상부위팔신경얼기병증 의심": {
            "meta": {
                ...
                "sex": "여성",
                "side": "왼쪽",
                "chief": "갑작스러운 왼쪽 어깨 통증 이후 어깨 벌림과 팔꿉관절 굽힘 약화. 위팔 가쪽 감각 저하.",
                "clinical_hint": "가쪽아래팔피부신경  감각신경활동전위(SNAP) 감소와 C5-C6 관련 여러 말초신경 근육 이상을 통해 위쪽 위팔신경얼기병증을 해석하는 사례입니다.",
            },
            "diagnosis": "왼쪽 위쪽 위팔신경얼기병증(Upper trunk brachial plexopathy)",
            "lesion": "왼쪽 위팔신경얼기 상부줄기, 주로 C5-C6 섬유",
            "sensory_ncs": [
                {
                    "nerve": "가쪽아래팔피부신경 감각신경활동전위(Lateral antebrachial cutaneous SNAP)",
                    "recording": "아래팔 가쪽",
                    "stimulation": "팔꿈치 근처",
                    "side": "좌측",
                    "amplitude": "4 μV",
            ...
            "motor_ncs": [
                {
                    "nerve": "겨드랑신경 복합근육활동전위(Axillary CMAP)",
                    "recording": "어깨세모근",
                ...
                {
                    "nerve": "근육피부신경 복합근육활동전위(Musculocutaneous CMAP)",
                    "recording": "위팔두갈래근",
                    "stimulation": "Erb's point",
                    "side": "좌측",
                    "amplitude": "2.0 mV",
            ...
            "interpretation": {
                "sensory": [
                    "가쪽아래팔피부신경  감각신경활동전위(SNAP)가 정상측보다 감소하여 병변이 뒤뿌리신경절보다 말초 쪽, 즉 위팔신경얼기 수준일 가능성을 시사합니다.",
                    "신경뿌리병증에서는  감각신경활동전위(SNAP)가 보존되는 경우가 많기 때문에,  감각신경활동전위(SNAP) 감소는 신경얼기병증 감별에 중요합니다.",
                ],
                "motor": [
                    "겨드랑신경과 근육피부신경 복합근육활동전위(CMAP) 진폭이 감소하여 C5-C6 섬유를 포함하는 상부위팔신경얼기 침범을 시사합니다.",
                    "정중신경 먼쪽(distal) 반응이 비교적 보존되면 손목 부위 단일 포착병변 가능성은 낮아집니다.",
                ],
                "emg": [
                    "어깨세모근, 위팔두갈래근, 가시아래근은 서로 다른 말초신경 지배를 받지만 C5-C6 및 상부줄기와 관련됩니다.",
                    "목 척추주위근이 보존되어 있어 C5-C6 신경뿌리병증보다는 상부위팔신경얼기병증을 더 지지합니다.",
                ],
                "integration": [
                    "어깨 통증 후 근력저하, 가쪽아래팔피부신경  감각신경활동전위(SNAP) 감소, C5-C6 관련 여러 말초신경 지배 근육의 탈신경, 척추주위근 보존을 종합하면 왼쪽 상부위팔신경얼기병증이 가장 타당합니다.",
                ],
                "differential": [
                    "C5-C6 신경뿌리병증: 목 척추주위근 이상이 동반될 수 있고  감각신경활동전위(SNAP)는 보존되는 경우가 많습니다.",
                    "겨드랑신경 단독병증: 어깨세모근 위주 이상으로 제한되고 위팔두갈래근이나 가시아래근 이상은 설명하기 어렵습니다.",
                    "Parsonage-Turner syndrome: 급성 어깨 통증 후 다초점 신경침범 양상으로 나타날 수 있어 임상적으로 함께 고려합니다.",
                ],
                "additional": [
                    "위팔신경얼기 MRI 또는 신경초음파를 고려합니다.",
                    "초기 통증 조절, 어깨관절 구축 예방, 견갑대 안정화 훈련이 중요합니다.",
                ],
            },
        },
        ...
        "오른쪽 말초성 얼굴신경마비 의심": {
            "meta": {
                ...
                "clinical_hint": "얼굴신경 복합근육활동전위(CMAP) 진폭 감소와 눈깜빡반사 R1/R2 이상을 해석하는 사례입니다.",
            },
            "diagnosis": "오른쪽 말초성 얼굴신경마비, Bell palsy 가능성",
            "lesion": "오른쪽 얼굴신경 말초부, 얼굴신경관 또는 그 먼쪽(distal)",
            "sensory_ncs": [],
            "motor_ncs": [
                {
                    "nerve": "얼굴신경 복합근육활동전위(Facial CMAP)",
                    "recording": "눈둘레근(Orbicularis oculi)",
                    "stimulation": "귓바퀴 앞",
                    "side": "우측",
                    "amplitude": "0.7 mV",
                    "latency": "4.9 ms",
                ...
                {
                    "nerve": "얼굴신경 복합근육활동전위(Facial CMAP)",
                    "recording": "입둘레근(Orbicularis oris)",
                    "stimulation": "귓바퀴 앞",
                    "side": "우측",
                    "amplitude": "0.5 mV",
                    "latency": "5.1 ms",
            ...
            "late_response": [
                {
                    "test": "눈깜빡반사 우측 자극-우측 R1",
                    "side": "우측",
                    "latency": "소실",
                    "amplitude": "-",
                },
                {
                    "test": "눈깜빡반사 우측 자극-우측 R2",
                    "side": "우측",
                    "latency": "소실",
                    "amplitude": "-",
                },
                {
                    "test": "눈깜빡반사 우측 자극-좌측 R2",
                    "side": "좌측",
                    "latency": "정상 범위",
                    "amplitude": "보존",
                },
                {
                    "test": "눈깜빡반사 좌측 자극-좌측 R1",
                    "side": "좌측",
                    "latency": "정상 범위",
                    "amplitude": "보존",
                },
            ...
            "interpretation": {
                "sensory": [
                    "얼굴신경은 주로 운동신경 평가가 핵심이며, 일반적인 팔다리  감각신경활동전위(SNAP)와 같은 방식으로 해석다리 않습니다.",
                    "임상적으로 이마 주름 감소와 눈 감기 어려움이 동반되면 말초성 얼굴신경마비 가능성이 높습니다.",
                ],
                "motor": [
                    "오른쪽 얼굴신경 복합근육활동전위(CMAP) 진폭이 정상측보다 현저히 감소하여 얼굴신경 운동축삭 침범 가능성을 시사합니다.",
                    "잠복기 지연과 진폭 감소가 함께 있어 말이집탈락과 축삭 손상이 혼재된 양상으로 해석할 수 있습니다.",
                ],
                "emg": [
                    "오른쪽 얼굴신경 지배 근육에서 비정상 자발전위와 운동단위 동원감소가 관찰됩니다.",
                    "삼차신경 지배 깨물근은 정상으로 보존되어 얼굴신경 병변에 국한된 양상입니다.",
                ],
                "integration": [
                    "오른쪽 얼굴 표정근 약화, 얼굴신경 복합근육활동전위(CMAP) 진폭 감소, 눈깜빡반사 우측 반응 소실, 얼굴 표정근 탈신경 소견을 종합하면 오른쪽 말초성 얼굴신경마비가 가장 타당합니다.",
                    "발병 10일째에 탈신경 전위가 관찰되면 축삭 손상 정도를 추정하는 데 도움이 됩니다.",
                ],
                "differential": [
                    "중추성 얼굴마비: 이마 근육은 비교적 보존되는 경우가 많고, 위운동신경세포 병변 징후가 동반될 수 있습니다.",
                    "삼차신경 병변: 감각저하 또는 깨물근 이상이 동반될 수 있습니다.",
                    "뇌줄기 병변: 다른 뇌신경 징후, 운동·감각로 이상이 함께 나타날 수 있습니다.",
                ],
                "additional": [
                    "눈 보호, 인공눈물, 각막 손상 예방 교육이 중요합니다.",
                    "발병 시기와 중증도에 따라 전문의 협진 및 약물치료 여부를 확인합니다.",
                    "표정근 재교육, 과도한 연합운동 예방, 단계적 안면운동 훈련을 고려합니다.",
                ],
            },
        },
    }
        ...
        clean_html(
            ...
            <div class="warn-card">
                ...
                <div class="case-bullet">
                    ...
                    몸쪽(proximal) 자극에서 진폭이 크게 떨어지면 국소 전도차단을 의심합니다.
                </div>
                <div class="case-bullet">
    ...
    st.markdown(
        clean_html(
            ...
            <div class="info-card">
                ...
                <div class="case-bullet">
                    • <b>전도차단</b>은 먼쪽(distal) 자극에서는 반응이 비교적 보존되지만, 병변을 지나 몸쪽(proximal) 자극했을 때 진폭이 크게 감소하는 패턴입니다.
                </div>
                <div class="case-bullet">
