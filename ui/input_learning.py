...
VIRTUAL_REPORTS = {
    "왼쪽 목/어깨 통증 및 팔 저림 (C6 신경뿌리병증 의심)": {
        ...
        "ncs_sensory": [["정중신경 감각신경활동전위(Median SNAP)", "25 μV", "2.8 ms", "정상 반응"], ["자신경 감각신경활동전위(Ulnar SNAP)", "22 μV", "2.5 ms", "정상 반응"]],
        "ncs_motor": [["정중신경 복합근육활동전위(Median CMAP) 손목", "-", "8.5 mV", "3.5 ms", "정상 반응"], ["정중신경 복합근육활동전위(Median CMAP) 팔꿈치", "-", "8.1 mV", "7.8 ms", "정상 반응"]],
        "emg": [
            ["위팔두갈래근(Biceps brachii)", "C5-C6", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소(reduced MU recruitment)", "비정상 반응(활동성 탈신경)"],
            ["긴노쪽손목폄근(ECRL)", "C6-C7", "비정상 반응(섬유자발전위, 양성예파)", "거대 운동단위 출현, 동원 감소", "비정상 반응(만성 재신경지배 동반)"],
            ["짧은엄지벌림근(APB)", "C8-T1", "전기적 침묵", "정상 동원", "정상 반응"],
            ["목 척추주위근(Cervical Paraspinal)", "C6", "비정상 반응(섬유자발전위, 양성예파)", "통증으로 인해 평가불가", "비정상 반응(활동성 탈신경)"]
        ],
        "interpretation": [
        ...
        "emg_meaning": [
            "섬유자발전위, 양성예파: 신경 지배를 탈락한 개별 근섬유막의 전기적 불안정성을 고발하는 이상 자발전위입니다.",
            "동원 감소: 수의수축(Volition) 시 동원 및 결합되는 운동단위(MU) 숫자의 정량적 감소 상태를 뜻합니다."
        ],
    ...
    "오른쪽 1~3번째 손가락 저림 및 야간통 (손목굴증후군 의심)": {
        ...
        "ncs_sensory": [["정중신경 감각신경활동전위(Median SNAP)", "8 μV (감소/정상측 25 μV)", "4.8 ms (지연/정상측 2.8 ms)", "비정상 반응"], ["자신경 감각신경활동전위(Ulnar SNAP)", "25 μV", "2.6 ms", "정상 반응"]],
        "ncs_motor": [["정중신경 복합근육활동전위(Median CMAP) 손목", "-", "3.1 mV (감소/정상측 8.5 mV)", "5.5 ms (지연/정상측 3.5 ms)", "비정상 반응"], ["정중신경 복합근육활동전위(Median CMAP) 팔꿈치", "-", "2.9 mV (감소)", "9.8 ms", "비정상 반응"]],
        "emg": [["짧은엄지벌림근(APB)", "C8-T1", "전기적 침묵", "정상 동원", "정상 반응"], ["첫째등쪽뼈사이근(FDI)", "C8-T1", "전기적 침묵", "정상 동원", "정상 반응"]],
        "interpretation": [
        ...
        "emg_meaning": [
            "전기적 침묵: 휴식 시 어떠한 비정상 전위 자발전위도 유발되지 않는 생리적 침묵 상태입니다.",
            "정상 동원: 등척성/등장성 수의수축 요구도에 맞추어 하위 운동 단위들이 조화롭게 동원되는 양상입니다."
        ],
    ...
    "왼쪽 허리 통증 및 엄지발가락 올림 약화 (L5 신경뿌리병증 의심)": {
        ...
        "ncs_sensory": [["얕은종아리신경 감각신경활동전위(Superficial Peroneal SNAP)", "12 μV", "2.9 ms", "정상 반응"], ["장딴지신경 감각신경활동전위(Sural SNAP)", "15 μV", "3.1 ms", "정상 반응"]],
        "ncs_motor": [["종아리신경 복합근육활동전위(Peroneal CMAP) 발목", "-", "3.5 mV", "4.5 ms", "정상 반응"], ["종아리신경 복합근육활동전위(Peroneal CMAP) 오금", "-", "3.3 mV", "11.2 ms", "정상 반응"]],
        "emg": [
            ["앞정강근(Tibialis Anterior)", "L4-L5", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(활동성 탈신경)"],
            ["긴종아리근(Peroneus Longus)", "L5-S1", "비정상 반응(섬유자발전위, 양성예파)", "거대 운동단위 출현, 동원 감소", "비정상 반응(만성 재신경지배 동반)"],
            ["가자미근(Soleus)", "S1-S2", "전기적 침묵", "정상 동원", "정상 반응"],
            ["허리 척추주위근(Lumbar Paraspinal)", "L5", "비정상 반응(섬유자발전위, 양성예파)", "통증으로 인해 평가불가", "비정상 반응(활동성 탈신경)"]
        ],
        "interpretation": [
            "다리의 주요 표재 감각신경활동전위(SNAP)들이 정상 보존되어 병터가 허리 뒤뿌리신경절(DRG)보다 몸쪽(Proximal)에 국한된 허리 신경뿌리(root) 장애임을 지시합니다.",
            "L5 신경 분절의 지배를 받는 앞정강근 및 긴종아리근, 그리고 허리 척추주위근육에서 비정상 자발전위가 동시에 터져 나와 L5 허리 신경뿌리병증으로 정의됩니다."
        ],
        "emg_meaning": [
            "거대 운동단위(Giant MUAP): 손상된 신경을 대신하여 생존 축삭이 발아(Sprouting)해 들어가 해당 탈신경 근섬유를 만성 재지배(Reinnervation)한 결과물입니다."
        ],
    ...
    "오른쪽 발처짐 및 종아리 가쪽 감각 저하 (온종아리신경 마비 의심)": {
        ...
        "ncs_sensory": [["얕은종아리신경 감각신경활동전위(Superficial Peroneal SNAP)", "4 μV (감소/정상측 12 μV)", "3.8 ms (지연)", "비정상 반응"], ["장딴지신경 감각신경활동전위(Sural SNAP)", "16 μV", "3.0 ms", "정상 반응"]],
        "ncs_motor": [["종아리신경 복합근육활동전위(Peroneal CMAP) 발목", "-", "4.5 mV", "4.8 ms", "정상 반응"], ["종아리신경 복합근육활동전위(Peroneal CMAP) 종아리뼈머리", "-", "1.1 mV (감소/정상측 4.5 mV)", "무반응", "비정상 반응(국소 전도차단)"]],
        "emg": [
            ["앞정강근(Tibialis Anterior)", "L4-L5", "전기적 침묵", "운동단위 동원 불가", "비정상 반응(전도 완전 마비)"],
            ["긴종아리근(Peroneus Longus)", "L5-S1", "전기적 침묵", "동원 감소", "비정상 반응(동원 감소)"],
            ["허리 척추주위근(Lumbar Paraspinal)", "L5", "전기적 침묵", "정상 동원", "정상 반응"]
        ],
        "interpretation": [
        ...
        "emg_meaning": [
            "전도차단(Conduction Block): 신경 축삭의 물리적 사멸이 유도되지 않은 상황에서 국소 압박에 기인하여 전기 자극 전달이 순간 차단되는 상태입니다."
        ],
    ...
    "양측 발끝 저림 및 감각 저하 (당뇨병성 다발신경병증 의심)": {
        ...
        "ncs_sensory": [["장딴지신경 감각신경활동전위(Sural SNAP) 우측", "무반응 (소실/정상측 15 μV)", "무반응", "비정상 반응(반응 소실)"], ["정중신경 감각신경활동전위(Median SNAP) 우측", "18 μV", "3.4 ms", "정상 반응"]],
        "ncs_motor": [["정강신경 복합근육활동전위(Tibial CMAP) 발목 우측", "-", "1.5 mV (감소/정상측 5.8 mV)", "6.2 ms (지연/정상측 4.2 ms)", "비정상 반응"], ["정강신경 복합근육활동전위(Tibial CMAP) 오금 우측", "-", "1.2 mV (감소)", "15.2 ms", "비정상 반응"]],
        "emg": [["앞정강근(Tibialis Anterior)", "L4-L5", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(대칭적 말초 축삭 퇴행)"], ["위팔두갈래근(Biceps brachii)", "C5-C6", "전기적 침묵", "정상 동원", "정상 반응"]],
        "interpretation": [
        ...
        "emg_meaning": [
            "Dying-back pattern: 대사 이상으로 인해 신경 가지 세포체에서 가장 거리가 먼 먼쪽(Distal) 신경축삭부터 퇴행성 사멸이 역행하여 진행하는 현상입니다."
        ],
    ...
    "팔다리 대칭성 근력 저하 (급성 기얭-바레 증후군 의심)": {
        ...
        "ncs_sensory": [["정중신경 감각신경활동전위(Median SNAP)", "22 μV", "3.8 ms (지연/정상측 2.8 ms)", "비정상 반응"], ["장딴지신경 감각신경활동전위(Sural SNAP)", "12 μV", "3.4 ms", "정상 반응(Sural Sparing)"]],
        "ncs_motor": [["종아리신경 복합근육활동전위(Peroneal CMAP) 발목", "-", "3.0 mV", "8.5 ms (지연/정상측 4.5 ms)", "비정상 반응"], ["종아리신경 복합근육활동전위(Peroneal CMAP) 종아리뼈머리", "-", "1.2 mV", "20.1 ms (지연)", "비정상 반응(전도속도 급감)"]],
        "emg": [["앞정강근(Tibialis Anterior)", "L4-L5", "전기적 침묵", "동원 감소", "비정상 반응(동원 결손)"], ["허리 척추주위근(Lumbar Paraspinal)", "L5", "전기적 침묵", "통증으로 인해 평가불가", "정상 반응"]],
        "interpretation": [
        ...
        "emg_meaning": [
            "Sural sparing effect: 자가면역 말이집 손상 시 다리 말단 감각인 장딴지 감각신경활동전위 반응이 홀로 정상 유지되는 전형적 기얭-바레 증후군(GBS) 판독 감별점입니다."
        ],
    ...
    "오른쪽 팔꿈치 통증 및 손가락 힘 빠짐 (C7 신경뿌리병증 의심)": {
        ...
        "ncs_sensory": [["정중신경 감각신경활동전위(Median SNAP)", "28 μV", "2.9 ms", "정상 반응"], ["자신경 감각신경활동전위(Ulnar SNAP)", "24 μV", "2.4 ms", "정상 반응"]],
        "ncs_motor": [["정중신경 복합근육활동전위(Median CMAP) 손목", "-", "9.2 mV", "3.6 ms", "정상 반응"], ["노신경 복합근육활동전위(Radial CMAP) 아래팔", "-", "6.5 mV", "2.8 ms", "정상 반응"]],
        "emg": [
            ["위팔세갈래근(Triceps brachii)", "C7-C8", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(활동성 탈신경)"],
            ["손목굽힘근(Flexor carpi radialis)", "C6-C7", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(활동성 탈신경)"],
            ["위팔두갈래근(Biceps brachii)", "C5-C6", "전기적 침묵", "정상 동원", "정상 반응"],
            ["목 척추주위근(Cervical Paraspinal)", "C7", "비정상 반응(섬유자발전위, 양성예파)", "통증으로 인해 평가불가", "비정상 반응(활동성 탈신경)"]
        ],
        "interpretation": [
    ...
    "S1 신경뿌리병증 의심 사례": {
        ...
        "ncs_sensory": [["장딴지신경 감각신경활동전위(Sural SNAP)", "14 μV", "3.0 ms", "정상 반응"], ["얕은종아리신경 감각신경활동전위(Superficial Peroneal SNAP)", "11 μV", "2.8 ms", "정상 반응"]],
        "ncs_motor": [["정강신경 복합근육활동전위(Tibial CMAP) 발목", "-", "5.8 mV", "4.2 ms", "정상 반응"], ["종아리신경 복합근육활동전위(Peroneal CMAP) 발목", "-", "4.8 mV", "4.5 ms", "정상 반응"]],
        "emg": [
            ["가자미근(Soleus)", "S1-S2", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(활동성 탈신경)"],
            ["장딴지근(Gastrocnemius)", "S1-S2", "비정상 반응(섬유자발전위, 양성예파)", "동원 감소", "비정상 반응(활동성 탈신경)"],
            ["앞정강근(Tibialis Anterior)", "L4-L5", "전기적 침묵", "정상 동원", "정상 반응"],
            ["허리 척추주위근(Lumbar Paraspinal)", "S1", "비정상 반응(섬유자발전위, 양성예파)", "통증으로 인해 평가불가", "비정상 반응(활동성 탈신경)"]
        ],
        "interpretation": [
    ...
    "오른쪽 어깨 통증 및 손 내재근 위축 (가슴문증후군 의심)": {
        ...
        "ncs_sensory": [["가쪽아래팔피부신경 감각신경활동전위(LAC SNAP)", "25 μV", "2.1 ms", "정상 반응"], ["안쪽아래팔피부신경 감각신경활동전위(MAC SNAP)", "2 μV (감소/정상측 15 μV)", "3.9 ms (지연/정상측 2.1 ms)", "비정상 반응"]],
        "ncs_motor": [["정중신경 복합근육활동전위(Median CMAP) 손목", "-", "3.8 mV (감소/정상측 8.5 mV)", "4.0 ms", "비정상 반응"], ["자신경 복합근육활동전위(Ulnar CMAP) 손목", "-", "4.1 mV", "3.2 ms", "정상 반응"]],
        "emg": [
            ["짧은엄지벌림근(APB)", "C8-T1", "전기적 침묵", "거대 운동단위 출현, 동원 감소", "비정상 반응(Gilliatt-Sumner hand)"],
            ["첫째등쪽뼈사이근(FDI)", "C8-T1", "전기적 침묵", "거대 운동단위 출현, 동원 감소", "비정상 반응(Gilliatt-Sumner hand)"],
            ["위팔두갈래근(Biceps brachii)", "C5-C6", "전기적 침묵", "정상 동원", "정상 반응"],
            ["목 척추주위근(C8-T1)", "C8-T1", "전기적 침묵", "정상 동원", "정상 반응"]
        ],
        "interpretation": [
    ...
    "왼쪽 갑작스러운 한쪽 얼굴 마비 (얼굴신경마비 의심)": {
        ...
        "ncs_sensory": [["오른쪽 이마 자극(V1)", "22 μV", "2.1 ms", "정상 반응"], ["왼쪽 이마 자극(V1)", "21 μV", "2.2 ms", "정상 반응"]],
        "ncs_motor": [["오른쪽 얼굴신경 복합근육활동전위(Facial CMAP) 코근", "-", "3.2 mV", "2.8 ms", "정상 반응"], ["왼쪽 얼굴신경 복합근육활동전위(Facial CMAP) 코근", "-", "1.1 mV (감소/정상측 3.2 mV)", "4.5 ms (지연/정상측 2.8 ms)", "비정상 반응"]],
        "emg": [["눈둘레근(Orbicularis Oculi)", "얼굴신경 지배", "전기적 침묵", "정상 동원", "정상 반응"]],
        "interpretation": [
            "왼쪽 얼굴 자극 시 운동 복합근육활동전위(Facial CMAP) 최대 진폭이 정상측 대비 50% 이하로 크게 감소해 있어, 심각한 먼쪽(distal) 운동 축삭 사멸 변성이 진행되고 있음을 측정해 냅니다.",
            "왼쪽 이마 주름 소실 및 눈 감기 불능의 완전한 말초성 마비 증상과 안면신경(Facial nerve) 자극 시 뚜렷한 진폭 비대칭 소견을 종합하여 말초성 얼굴신경마비(Bell's palsy)로 최종 진단합니다."
        ],
        "emg_meaning": [
...
def render_input_learning():
    ...
    if selected != "선택 안 함":
        ...
        st.markdown('<div class="content-card">', unsafe_allow_html=True)
        st.markdown(format_title_box("주요 임상 증상"), unsafe_allow_html=True)
        st.markdown(f'<div style="font-size:0.9rem; color:#334155;">• {format_inline_eng(data["info"]["symptom"])}</div>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)

        st.markdown('<div class="content-card">', unsafe_allow_html=True)
        st.markdown(f"<div style='font-size:1.0rem; font-weight:800; color:#1e40af; margin-bottom:12px;'>근전도 검사 결과 (병변측: {data['info']['side']})</div>", unsafe_allow_html=True)
        ...
        def render_table_section(title_kor, headers, rows):
            ...
            for row in rows:
                ...
                is_emg = "침근전도" in title_kor
                
                st.markdown(f"<div style='font-size:0.95rem; font-weight:800; color:#1e293b; margin-top:12px; margin-bottom:6px;'>{nerve}</div>", unsafe_allow_html=True)
        ...
        diag_name = f"{data['info']['side']} {data['diagnosis'].split('(')[0].replace('왼쪽', '').replace('오른쪽', '').strip()} ({data['diagnosis'].split('(')[1]}" if "(" in data["diagnosis"] else data["diagnosis"]
        st.markdown(f"""
        ...
        st.markdown(f'<div class="case-bullet">{remove_english_parens(data["ddx"])}</div>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
