...
def render_home():
    st.markdown('<div style="margin-bottom:20px;"><div style="font-size:1.25rem; font-weight:800; color:#0f172a; line-height:1.2; text-align:center;">교육용 근전도 판독 보조 앱</div></div>', unsafe_allow_html=True)
    st.markdown('<div style="font-size:0.9rem; color:#334155; margin-bottom:24px; text-align:center;">물리치료학과 학생 및 임상 전문가를 위한 교육용 근전도 판독 훈련 앱입니다.</div>', unsafe_allow_html=True)
