...
주의:
- 본 자료는 교육용 예시입니다.
- 신경전도검사 정상범위는 장비, 검사실, 피부온도, 나이, 키, 팔다리 길이, 자극/기록 위치에 따라 달라질 수 있습니다.
- 배열의 순서는 항상 [좌측 결과, 우측 결과] 입니다.
"""
...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "팔꿉관절 굽힘(Elbow flexion): Fair (3/5) - 위팔두갈래근(Biceps brachii), 근육피부신경(Musculocutaneous nerve, C5-C6), C6 우세",
                    "손목관절 폄(Wrist extension): Fair (3/5) - 긴노쪽손목폄근(Extensor carpi radialis longus): 노신경(Radial nerve, C6-C7), C6 우세",
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "감각신경활동전위(SNAP)가 정상 범위로 보존됩니다. 신경뿌리병증은 병변이 뒤뿌리신경절(DRG)보다 몸쪽에 있어 말초 감각신경전도가 정상 범위일 수 있습니다.",
    ...
    "야간 손저림과 엄지 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "야간 손저림, 정중신경 분포 감각저하, 엄지손가락 벌림 약화, 정중신경 전도 지연과 진폭 감소를 종합하면 손목굴증후군으로 판단할 수 있습니다."
            ]
        },
        "differential_diagnosis": [
            {
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "온종아리신경병증에서는 얕은종아리신경 SNAP 감소, 종아리신경 CMAP 감소가 흔하며 중간볼기근과 척추주위근은 정상이어야 합니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "발처짐에서 발목 안쪽번짐이 정상이라면 종아리신경병증 가능성을 강하게 고려하세요."
            }
        ]
    },
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "양측 어깨관절 벌림(Shoulder abduction): Fair (3/5)",
                    "양측 엉덩관절 굽힘(Hip flexion): Fair (3/5)",
                    "양측 손목관절 폄(Wrist extension): Fair (3/5)",
                    "양측 발목관절 등굽힘(Ankle dorsiflexion): Fair (3/5)"
                ],
                "반사 검사": [
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "우측 눈 꽉 감기(Eye closure): Good (4/5)",
                    "이마 주름잡기(Eyebrow elevation): Normal (5/5)",
                    "입꼬리 올리기(Smiling): Normal (5/5)"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "얼굴신경병증이 의심될 때는 얼굴근육 침근전도에서 섬유자발전위, 양성예파, 운동단위 동원 감소 등을 추가로 확인할 수 있습니다."
            ],
            "integration": [
    ...
    "뇌졸중 후 발목 발바닥굽힘근 경직 평가": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "우측 발목관절 등굽힘(Ankle dorsiflexion): Poor (2/5)",
                    "우측 발목관절 발바닥굽힘(Ankle plantarflexion): Poor (2/5)",
                    "근긴장도(Muscle tone): 발목 발바닥굽힘근 수정애쉬워스척도(MAS) 3등급"
                ],
                "반사 검사": [
    ...
    "급성 양측 다리 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "양측 엉덩관절 굽힘(Hip flexion): Poor (2/5)",
                    "양측 무릎관절 폄(Knee extension): Fair (3/5)",
                    "양측 발목관절 등굽힘(Ankle dorsiflexion): Fair (3/5)"
                ],
                "반사 검사": [
    ...
    "아침 기상 시 손목처짐이 갑자기 생긴 경우": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "손목관절 폄(Wrist extension): Poor (2/5)",
                    "손가락 폄(Finger extension): Poor (2/5)",
                    "팔꿉관절 폄(Elbow extension): Normal (5/5)"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "노신경 지배 원위부 근육에서 비정상 자발전위가 나타나면 축삭 손상이 동반된 압박성 병변으로 해석할 수 있습니다.",
    ...
    "엉덩이 주사 후 종아리 뒤가쪽 통증과 발바닥굽힘 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "무릎관절 굽힘(Knee flexion): Fair (3/5)",
                    "발목관절 발바닥굽힘(Ankle plantarflexion): Poor (2/5)",
                    "발가락 굽힘(Toe flexion): Poor (2/5)",
                    "발목관절 등굽힘(Ankle dorsiflexion): Normal (5/5)"
                ],
                "반사 검사": [
