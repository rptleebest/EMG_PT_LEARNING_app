...
ANATOMY = {
    ...
    # -----------------------------------------------------------------
    # Blink reflex
    # 구심성/원심성 -> 들방향/날방향으로 통일
    # -----------------------------------------------------------------
    "우측 자극-우측 R1": {
        "nerve": "우측 삼차신경 들방향(afferent)-뇌줄기-우측 얼굴신경 날방향(efferent) 반사경로",
        "level": "눈깜빡반사 경로",
        "domain": "blink",
        "region": "face",
    },
    ...
    "우측 자극-좌측 R2": {
        "nerve": "우측 삼차신경 들방향(afferent)-뇌줄기-좌측 얼굴신경 날방향(efferent) 반사경로",
        "level": "눈깜빡반사 경로",
        "domain": "blink",
        "region": "face",
    },
    "좌측 자극-좌측 R1": {
        "nerve": "좌측 삼차신경 들방향(afferent)-뇌줄기-좌측 얼굴신경 날방향(efferent) 반사경로",
        "level": "눈깜빡반사 경로",
        "domain": "blink",
        "region": "face",
    },
    ...
    "좌측 자극-우측 R2": {
        "nerve": "좌측 삼차신경 들방향(afferent)-뇌줄기-우측 얼굴신경 날방향(efferent) 반사경로",
        "level": "눈깜빡반사 경로",
        "domain": "blink",
        "region": "face",
    },
