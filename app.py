...
def apply_mobile_first_style():
    ...
    div[data-testid="stMarkdownContainer"], div[data-testid="stText"], p, li, span, label {
        color: var(--text);
    }
    ...
    .case-title-mobile, .case-subheading, .finding-item-title, .result-title, .input-title {
        font-size: 0.94rem;
        font-weight: 800;
        color: var(--text) !important;
        line-height: 1.5;
    ...
    .case-subtitle-mobile, .mobile-note, .input-meta {
        color: var(--muted) !important;
    }

    /* 문단 간격 대폭 확대 및 줄간격 최적화 */
    .case-bullet, .case-bullet-strong, .finding-subtext, .result-text, .result-small {
        font-size: 0.88rem;
    ...
    .finding-highlight {
        color: #1e3a8a !important; /* 어두운 네이비 */
    ...
    /* 내용(오른쪽) 굵기 조절: 얇은 400 강제 적용으로 시각적 피로 완화 */
    .result-value { 
    ...
    @media (max-width: 768px) {
        ...
        /* 모바일 폰트 최적화 */
        .case-bullet, .case-bullet-strong, .finding-subtext, .result-text { 
            font-size: 0.86rem !important; 
            line-height: 1.7 !important; 
            margin-bottom: 10px !important; 
        }
        .label-strong { font-size: 0.86rem !important; }
        .result-value { font-size: 0.86rem !important; }
