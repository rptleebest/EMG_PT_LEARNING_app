...
RESULT_OPTIONS = [
    ...
    RESULT_EMG_NORMAL, RESULT_EMG_ACTIVE_DENERVATION, RESULT_EMG_ACTIVE_DENERVATION_WITH_REDUCED_RECRUITMENT, RESULT_EMG_FASCICULATION
]
...
DOMAIN_RESULT_OPTIONS = {
    ...
    "muscle": [RESULT_EMG_NORMAL, RESULT_EMG_ACTIVE_DENERVATION, RESULT_EMG_ACTIVE_DENERVATION_WITH_REDUCED_RECRUITMENT, RESULT_EMG_FASCICULATION],
