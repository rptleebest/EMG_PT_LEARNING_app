...
VIRTUAL_REPORTS = {
    ...
    "5. 오른쪽 손목처짐 및 손등 감각 저하 (노신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["노신경", "나선고랑 위", "오른쪽", "1.5 mV", "10.1 ms", "21 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "표재노신경 감각전도 저하와 함께, 나선고랑 상/하부 자극에서 전도속도가 21 m/s로 저하되며 운동 진폭이 급감하는 국소 전도차단 수치가 기록되어 물리적 압박 위치를 지시합니다."
            ],
            "emg_reason": [
