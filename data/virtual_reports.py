...
VIRTUAL_REPORTS = {
    "1. 왼쪽 목 통증 및 엄지/검지 저림 (C6 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ["정중신경 첫째 가지", "오른쪽", "22 μV", "2.6 ms", "정상 범위"],
            ["정중신경 첫째 가지", "왼쪽", "21 μV", "2.7 ms", "정상 범위"],
            ["정중신경 둘째 가지", "오른쪽", "25 μV", "2.8 ms", "정상 범위"],
            ["정중신경 둘째 가지", "왼쪽", "24 μV", "2.8 ms", "정상 범위"],
            ["자신경 다섯째 가지", "오른쪽", "22 μV", "2.5 ms", "정상 범위"],
            ["자신경 다섯째 가지", "왼쪽", "21 μV", "2.6 ms", "정상 범위"],
        ...
        "ncs_motor": [
            ...
            ["정중신경", "팔꿈치", "왼쪽", "7.9 mV", "7.4 ms", "53 m/s", "정상 범위"],
            ["자신경", "손목", "오른쪽", "7.5 mV", "2.8 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "오른쪽", "7.2 mV", "6.5 ms", "57 m/s", "정상 범위"],
            ["자신경", "손목", "왼쪽", "7.3 mV", "2.9 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "왼쪽", "7.0 mV", "6.7 ms", "56 m/s", "정상 범위"],
            ["노신경", "아래팔", "왼쪽", "6.5 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "왼쪽", "6.1 mV", "5.1 ms", "62 m/s", "정상 범위"],
            ["근육피부신경", "위팔", "왼쪽", "5.8 mV", "2.1 ms", "-", "정상 범위"],
            ["근육피부신경", "겨드랑이", "왼쪽", "5.4 mV", "4.8 ms", "60 m/s", "정상 범위"],
        ],
        "emg": [
    ...
    "2. 오른쪽 1~3번째 손가락 저림 (손목굴증후군)": {
        ...
        "ncs_sensory": [
            ["정중신경 첫째 가지", "오른쪽", "9 μV", "4.9 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경 둘째 가지", "오른쪽", "10 μV", "4.8 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경 셋째 가지", "오른쪽", "11 μV", "4.8 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경 셋째 가지", "왼쪽", "26 μV", "2.7 ms", "정상 범위"],
            ["자신경 다섯째 가지", "오른쪽", "24 μV", "2.5 ms", "정상 범위"],
            ["노신경", "오른쪽", "20 μV", "2.2 ms", "정상 범위"],
            ["등쪽자신경", "오른쪽", "18 μV", "2.3 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["정중신경", "손목", "오른쪽", "4.5 mV", "5.8 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "팔꿈치", "오른쪽", "4.2 mV", "9.5 ms", "51 m/s", "비정상 (손목 지연 지속)"],
            ["정중신경", "손목", "왼쪽", "8.1 mV", "3.6 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "왼쪽", "7.8 mV", "7.4 ms", "53 m/s", "정상 범위"],
            ["자신경", "손목", "오른쪽", "7.6 mV", "2.9 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "오른쪽", "7.4 mV", "6.5 ms", "58 m/s", "정상 범위"],
            ["노신경", "아래팔", "오른쪽", "6.8 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "오른쪽", "6.5 mV", "5.2 ms", "62 m/s", "정상 범위"],
        ],
        "emg": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "오른쪽 정중신경의 여러 감각 분지(1, 2, 셋째 가지)와 운동 신경에서만 잠복기가 뚜렷하게 지연되어 손목굴 부위 압박을 지시합니다.",
    ...
    "3. 왼쪽 허리/엉치 통증 및 발처짐 (L5 신경뿌리병증)": {
        ...
        "ncs_motor": [
            ...
            ["종아리신경", "종아리뼈머리 아래", "왼쪽", "4.3 mV", "10.2 ms", "48 m/s", "정상 범위"],
            ["종아리신경", "발목", "오른쪽", "4.8 mV", "4.2 ms", "-", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "오른쪽", "4.6 mV", "9.8 ms", "50 m/s", "정상 범위"],
            ["정강신경", "발목", "왼쪽", "5.5 mV", "5.0 ms", "-", "정상 범위"],
            ["정강신경", "오금", "왼쪽", "5.2 mV", "13.5 ms", "45 m/s", "정상 범위"],
            ["넓적다리신경", "무릎 위", "왼쪽", "6.2 mV", "4.1 ms", "-", "정상 범위"],
            ["넓적다리신경", "고샅부위", "왼쪽", "6.0 mV", "8.5 ms", "52 m/s", "정상 범위"],
        ],
        "emg": [
    ...
    "4. 오른쪽 4~5번째 손가락 저림 (팔꿈치굴증후군)": {
        ...
        "ncs_sensory": [
            ["자신경 다섯째 가지", "오른쪽", "9 μV", "3.4 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["자신경 다섯째 가지", "왼쪽", "22 μV", "2.5 ms", "정상 범위"],
            ["등쪽자신경", "오른쪽", "12 μV", "2.6 ms", "비정상 (진폭 감소)"],
            ["정중신경 둘째 가지", "오른쪽", "24 μV", "2.8 ms", "정상 범위"],
            ["안쪽아래팔피부신경", "오른쪽", "20 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["자신경", "손목", "오른쪽", "7.2 mV", "3.0 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "오른쪽", "7.0 mV", "6.5 ms", "56 m/s", "정상 범위"],
            ["자신경", "팔꿈치 위", "오른쪽", "3.1 mV", "11.2 ms", "23 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정중신경", "손목", "오른쪽", "8.5 mV", "3.5 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "오른쪽", "8.2 mV", "7.2 ms", "54 m/s", "정상 범위"],
        ],
        "emg": [
            ...
            ["깊은손가락굽힘근 4-다섯째 가지", "C8-T1", "오른쪽", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
    ...
    "5. 오른쪽 손목처짐 및 손등 감각 저하 (노신경 마비)": {
        ...
        "ncs_motor": [
            ["노신경", "아래팔", "오른쪽", "6.8 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "오른쪽", "6.5 mV", "5.2 ms", "60 m/s", "정상 범위"],
            ["노신경", "나선고랑(spiral groove) 위", "오른쪽", "1.5 mV", "10.1 ms", "21 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정중신경", "손목", "오른쪽", "8.2 mV", "3.4 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "오른쪽", "7.9 mV", "7.1 ms", "55 m/s", "정상 범위"],
        ],
        "emg": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "표재노신경 감각전도 저하와 함께, 나선고랑(spiral groove) 상/하부 자극에서 전도속도가 21 m/s로 저하되며 운동 진폭이 급감하는 국소 전도차단 수치가 기록되어 물리적 압박 위치를 지시합니다."
            ],
            "emg_reason": [
                "나선고랑(spiral groove) 하부에서 신경 지배를 받는 위팔노근 및 폄근들은 일제히 탈신경 소견을 보입니다.",
                "나선고랑(spiral groove) 상부에서 먼저 분지되는 위팔세갈래근이 정상 범위인 것은 신경 병변이 겨드랑이나 목이 아님을 해부학적으로 증명합니다."
            ],
            "integration": [
                "위팔세갈래근 보존, 나선고랑(spiral groove) 부위 전도차단, 하부 폄근들의 선택적 마비를 통합하여 'Saturday night palsy' 형태의 노신경 마비로 확진합니다."
            ]
        },
    ...
    "6. 오른쪽 엉덩이 통증 및 까치발 보행 어려움 (S1 신경뿌리병증)": {
        ...
        "ncs_motor": [
            ...
            ["정강신경", "오금", "오른쪽", "5.8 mV", "14.2 ms", "48 m/s", "정상 범위"],
            ["정강신경", "발목", "왼쪽", "6.4 mV", "4.7 ms", "-", "정상 범위"],
            ["정강신경", "오금", "왼쪽", "6.1 mV", "14.0 ms", "49 m/s", "정상 범위"],
            ["종아리신경", "발목", "오른쪽", "5.2 mV", "4.1 ms", "-", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "오른쪽", "5.0 mV", "10.0 ms", "46 m/s", "정상 범위"],
        ],
        "emg": [
    ...
    "7. 왼쪽 발처짐 및 발목 바깥쪽 무딤 (온종아리신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["종아리신경", "종아리뼈머리 아래", "왼쪽", "4.8 mV", "10.0 ms", "45 m/s", "정상 범위"],
            ["종아리신경", "오금", "왼쪽", "1.2 mV", "14.5 ms", "22 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정강신경", "발목", "왼쪽", "6.2 mV", "4.5 ms", "-", "정상 범위"],
            ["정강신경", "오금", "왼쪽", "5.9 mV", "13.5 ms", "48 m/s", "정상 범위"],
        ],
        "emg": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "얕은종아리신경 감각전도가 저하되었으며, 종아리뼈머리(Fibular head) 상하부 자극 시 운동 전도속도가 급감(22m/s)하는 국소 전도차단(conduction block)이 확인되어 무릎 가쪽 압박을 특정합니다."
            ],
            "emg_reason": [
    ...
    "8. 오른쪽 어깨 통증 및 어깨세모근 약화 (C7 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ["정중신경 셋째 가지", "오른쪽", "28 μV", "2.7 ms", "정상 범위"],
            ["정중신경 셋째 가지", "왼쪽", "29 μV", "2.6 ms", "정상 범위"],
            ["정중신경 둘째 가지", "오른쪽", "26 μV", "2.7 ms", "정상 범위"],
            ["자신경 다섯째 가지", "오른쪽", "24 μV", "2.4 ms", "정상 범위"],
            ["노신경", "오른쪽", "19 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["노신경", "아래팔", "오른쪽", "7.1 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "오른쪽", "6.9 mV", "5.1 ms", "62 m/s", "정상 범위"],
            ["정중신경", "손목", "오른쪽", "8.8 mV", "3.2 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "오른쪽", "8.5 mV", "7.0 ms", "55 m/s", "정상 범위"],
            ["자신경", "손목", "오른쪽", "7.5 mV", "2.8 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "오른쪽", "7.2 mV", "6.4 ms", "57 m/s", "정상 범위"],
        ],
        "emg": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "저림 호소 부위인 가운데 손가락(정중신경 셋째 가지)의 감각 전도가 정상인 것은, 말초신경 병변이 아닌 근위부 신경뿌리 병변의 전형적 소견입니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "팔 펴는 힘의 약화와 손등 저림이 비슷다리만, 노신경 마비라면 정중신경 지배인 노쪽손목굽힘근이나 목 척추주위근은 정상이어야 합니다."
            }
        ]
    },
    ...
    "10. 양측 발바닥 저림 및 통증 (다발신경병증)": {
        ...
        "ncs_sensory": [
            ...
            ["정중신경 둘째 가지", "오른쪽", "12 μV", "3.8 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경 둘째 가지", "왼쪽", "13 μV", "3.7 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["자신경 다섯째 가지", "오른쪽", "14 μV", "3.1 ms", "비정상 (진폭 감소)"],
            ["자신경 다섯째 가지", "왼쪽", "15 μV", "3.0 ms", "비정상 (진폭 감소)"],
        ],
        "ncs_motor": [
            ["정강신경", "발목", "오른쪽", "1.8 mV", "6.2 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "오금", "오른쪽", "1.5 mV", "15.8 ms", "38 m/s", "비정상 (전도속도 저하)"],
            ["정강신경", "발목", "왼쪽", "1.7 mV", "6.4 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "오금", "왼쪽", "1.4 mV", "16.1 ms", "37 m/s", "비정상 (전도속도 저하)"],
            ["종아리신경", "발목", "오른쪽", "2.1 mV", "5.8 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "종아리뼈머리 아래", "오른쪽", "1.8 mV", "14.5 ms", "39 m/s", "비정상 (전도속도 저하)"],
            ["종아리신경", "발목", "왼쪽", "2.0 mV", "5.9 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "종아리뼈머리 아래", "왼쪽", "1.7 mV", "14.8 ms", "38 m/s", "비정상 (전도속도 저하)"],
            ["정중신경", "손목", "오른쪽", "6.5 mV", "4.1 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "오른쪽", "6.2 mV", "8.5 ms", "52 m/s", "정상 범위"],
