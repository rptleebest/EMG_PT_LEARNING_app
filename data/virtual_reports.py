...
VIRTUAL_REPORTS = {
    ...
    "3. 왼쪽 허리/엉치 통증 및 발처짐 (L5 신경뿌리병증)": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "이는 병변이 감각세포체 몸쪽인 척수 신경뿌리에 위치하여, 말초 감각신경의 퇴행을 유발하지 않았음을 증명합니다."
            ],
            "emg_reason": [
    ...
    "5. 오른쪽 손목처짐 및 손등 감각 저하 (요골신경 마비)": {
        "info": {"age": 34, "sex": "남성", "symptom": "음주 후 의자에서 잔 뒤 발생한 우측 손목처짐 및 손등 저림", "side": "오른쪽"},
        "diagnosis": "오른쪽 요골신경 마비",
        "ncs_sensory": [
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "위팔세갈래근의 보존, 나선고랑 부위 국소 전도차단 데이터, 그리고 하부 폄근들의 선택적 마비를 통합하여 요골신경 압박 마비로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "후골간신경 마비 (PIN Syndrome)",
                "how_to_differentiate": "후골간신경 마비는 순수 운동신경 분지 마비이므로 감각 소실이 없으며 표재노신경 감각 전도가 정상 수치로 기록되어야 합니다."
            }
        ]
    },

    "6. 오른쪽 엉치 방사통 및 종아리 약화 (S1 신경뿌리병증)": {
        "info": {"age": 50, "sex": "남성", "symptom": "우측 엉치에서 발바닥으로 당기는 통증, 까치발 걷기가 힘듦", "side": "오른쪽"},
    ...
    "7. 왼쪽 발처짐 및 종아리 가쪽 무딤 (온종아리신경 마비)": {
        "info": {"age": 28, "sex": "여성", "symptom": "다리를 꼬고 오래 앉은 후 발생한 좌측 발처짐 및 감각 무딤", "side": "왼쪽"},
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "무릎 상부에서 분지되는 넙다리두갈래근(짧은갈래)과 척추주위근이 정상 범위인 것은 궁둥신경이나 척추 뿌리 문제가 아님을 명확히 입증합니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                "name": "L5 허리 신경뿌리병증",
                "how_to_differentiate": "L5 병변이라면 감각전도가 양측 대칭적으로 정상이어야 하며, 척추주위근 및 중둔근에서 비정상 활동성 탈신경 소견이 나타나야 합니다."
            }
        ]
    },

    "8. 오른쪽 어깨 뻐근함 및 삼두근 약화 (C7 신경뿌리병증)": {
        "info": {"age": 51, "sex": "여성", "symptom": "우측 날개뼈 안쪽 통증, 팔 뒤쪽부터 가운데 손가락까지 저림, 팔 펴는 힘 빠짐", "side": "오른쪽"},
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "가운데 손가락 저림이 뚜렷함에도 정중신경 3지의 감각 진폭이 정상 범위로 유지되는 전형적인 근위부 병변입니다."
            ],
            "emg_reason": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "요골신경 마비라면 정중신경 지배를 받는 노쪽손목굽힘근이나 척추주위근은 정상 범위여야 합니다."
            }
        ]
    },

    "9. 왼쪽 갑작스러운 안면 마비 (벨마비)": {
        "info": {"age": 35, "sex": "여성", "symptom": "자고 일어난 후 좌측 얼굴 전체 마비, 이마 주름 소실 및 눈이 안 감김", "side": "왼쪽"},
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "감각을 담당하는 삼차신경은 정상이지만, 얼굴신경 운동 진폭이 우측 대비 크게 감소하여 심각한 축삭 변성을 시사합니다."
            ],
            "emg_reason": [
                "시간이 지나 눈둘레근에서 활동성 탈신경 전위가 뚜렷하게 관찰됩니다.",
                "저작근(삼차신경 지배)은 정상이므로 복합 뇌신경 마비가 아님을 확인합니다."
            ],
            "integration": [
    ...
    "10. 양측 발끝 화끈거림 (다발신경병증)": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "가장 긴 신경인 다리 장딴지신경 반응이 소실되고, 상지 정중신경도 진폭이 감소한 전형적인 길이의존성 패턴입니다."
            ],
            "emg_reason": [
                "다리 원위부 근육인 양측 앞정강근에서 대칭적인 활동성 탈신경이 확인됩니다.",
                "상지 근위부 근육은 정상 범위인 것을 볼 때, 몸에서 가장 먼 신경 말단부터 서서히 퇴행하는 기전임을 확증합니다."
            ],
            "integration": [
                "양측 전도의 대칭적 소실 데이터와, 원위부 우세 EMG 이상 소견을 통합하여 다발신경병증으로 결론 내립니다."
            ]
        },
        "differential_diagnosis": [
            {
