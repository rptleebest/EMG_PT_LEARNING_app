...
VIRTUAL_REPORTS = {
    "왼쪽 목 통증 및 엄지/검지 저림 (C6 신경뿌리병증)": {
        ...
        "ncs_motor": [
            # 정중신경: 손목 정상 -> 손목 병변 -> 팔꿈치 정상 -> 팔꿈치 병변
            ...
            # 자신경: 손목 정상 -> 손목 병변 -> 팔꿈치 아래 정상 -> 팔꿈치 아래 병변
    ...
    "왼쪽 허리/엉치 통증 및 발처짐 (L5 신경뿌리병증)": {
        ...
        "ncs_motor": [
            # 종아리신경: 발목 정상 -> 발목 병변 -> 종아리뼈머리 아래 정상 -> 종아리뼈머리 아래 병변
        ...
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "반사 검 시 위팔세갈래근 반사(Triceps reflex)가 한쪽만 떨어져 있는지 양측을 세밀하게 비교하는 것이 중요합니다."
            }
        ]
    },
    ...
    "양측 발바닥 저림 및 통증 (다발신경병증)": {
        ...
        "ncs_motor": [
            ...
            # 종아리신경: 발목 우 -> 발목 좌 -> 종아리뼈머리 아래 우 -> 종아리뼈머리 아래 좌
