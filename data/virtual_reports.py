...
VIRTUAL_REPORTS = {
    ...
    "왼쪽 발처짐 및 발목 바깥쪽 무딤 (온종아리신경 마비)": {
        "info": {"age": 28, "sex": "여성", "symptom": "타이트한 부츠를 장기간 및 장시간 착용한 이후 왼쪽 발목이 안 들리고 발등 감각이 무딤", "side": "Lt"},
        "ncs_sensory": [
    ...
    "갑작스러운 왼쪽 얼굴 마비 (벨마비)": {
        "info": {"age": 35, "sex": "여성", "symptom": "자고 일어난 후 왼쪽 얼굴 근육이 움직이지 않고 눈이 안 감김, 이마 주름 잡기 불가. 2주 후 근전도 검사 시행", "side": "Lt"},
        "ncs_sensory": [
