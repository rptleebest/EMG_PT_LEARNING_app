...
VIRTUAL_REPORTS = {
    ...
    "오르녹 4~5번째 손가락 저림 (팔꿈치굴증후군)": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "팔꿈치보다 몸쪽(proximal)에서 분지되는 자쪽손목굽힘근(FCU)과 동일 C8-T1 분절 지배를 받는 정중신경 지배근(APB), 척추주위근은 완전한 정상입니다."
            ],
            "integration": [
    ...
    "왼쪽 발처짐 및 발목 바깥쪽 무딤 (온종아리신경 마비)": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "무릎 부위 국소 전도차단 지표와, 무릎 하부 근육들의 선택적 마비 및 몸쪽(proximal) 보존 소견을 통합하여 온종아리신경 압박 마비로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "양측 발바닥 저림 및 통증 (다발신경병증)": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "다리 최먼쪽(distal) 근육(앞정강근, 장딴지근)에서는 탈신경이 보이나, 몸쪽(proximal)(가쪽넓은근, 팔 근육)는 정상인 'Dying-back' 양상입니다."
            ],
            "integration": [
                "양측 신경 전도의 대칭적 소실과 먼쪽(distal) Rt세 근전도검사 이상을 통해 당뇨성 증상 등과 부합하는 전신성 다발신경병증으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
