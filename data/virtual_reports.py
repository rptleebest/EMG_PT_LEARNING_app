...
ENG_MAP = {
    ...
    "1단계: 감각신경전도검사 해석": "Step 1: Sensory NCS Interpretation",
    "2단계: 운동신경전도/반사검사 해석": "Step 2: Motor NCS & Reflex Interpretation",
    "3단계: 침근전도검사 해석": "Step 3: Needle EMG Interpretation",
    "4단계: 검사결과 추정 질환 및 통합 물리치료 의사결정": "Step 4: Suspected Disease & Integrated PT Decision Making",
    "감별진단 가이드": "Differential Diagnosis Guide",
...
VIRTUAL_REPORTS = {
    "오른쪽 손목굴증후군 의심": {
        ...
        "interpretation": {
            "sensory": [
                "오른쪽 정중신경 감각신경활동전위(SNAP)는 정상측인 왼쪽에 비해 진폭이 7 μV로 크게 낮고 잠복기가 지연되어 있습니다.",
                "동일한 손의 자신경 감각신경은 정상적으로 보존되어 있으므로, 다발성 병변이 아닌 정중신경의 국소적 병변을 시사합니다."
            ],
            "motor": [
                "오른쪽 정중신경 운동검사 시 손목 자극에서 원위잠복기가 5.8 ms로 뚜렷하게 지연되어 있습니다.",
                "복합근육활동전위(CMAP) 진폭도 저하되어 있어 단순 압박(말이집탈락)을 넘어 운동 축삭 손상이 시작되었음을 가리킵니다."
            ],
            "emg": [
                "정중신경 지배를 받는 짧은엄지벌림근(APB)에서 탈신경 자발전위가 검출되어 활동성 손상을 입증합니다.",
                "척추주위근과 자신경 지배 근육은 정상입니다."
            ],
            "decision_making": [
                "**🎯 최종 추정 질환**: 오른쪽 손목굴증후군(Carpal tunnel syndrome)",
                "**📍 병변 위치 추론 요약**: 자신경과 척추주위근이 정상인 상태에서 정중신경에 국한된 전도 지연 및 진폭 감소, 짧은엄지벌림근의 탈신경 소견이 일치하므로 손목굴 부위의 정중신경 포착으로 확진할 수 있습니다.",
                "**💡 통합 물리치료 의사결정**: 야간 부목(Splint) 착용을 교육하고, 손목의 과도한 굽힘/폄을 제한합니다. 보존적 치료로 정중신경 활주 운동(Nerve gliding)을 적용하되, 축삭 손상 징후가 있으므로 근력 저하 악화 시 전문의 수술적 개입을 의뢰해야 합니다."
            ],
            "differential": [
    ...
    "왼쪽 C6 신경뿌리병증 의심": {
        ...
        "interpretation": {
            "sensory": [
                "환자는 뚜렷한 손가락 저림을 호소하지만, 정중신경과 노신경의 감각신경활동전위(SNAP)는 대칭적으로 완벽하게 보존되어 있습니다.",
                "이는 병변이 감각신경 세포체(DRG)보다 중추 쪽인 신경뿌리(Root)에 위치함을 강력히 시사하는 생리학적 증거입니다."
            ],
            "motor": [
                "정중신경 및 노신경의 말초 운동 전도검사에서 전도차단이나 잠복기 지연이 발견되지 않습니다."
            ],
            "emg": [
                "근육피부신경 지배(위팔두갈래근)와 노신경 지배(노쪽손목폄근)라는 서로 다른 말초신경계 근육에서 동시 탈신경 소견이 보입니다.",
                "이 근육들은 'C6 분절'이라는 공통 뿌리를 갖습니다. 결정적으로 목 척추주위근(뒤가지)에서도 탈신경 전위가 확인됩니다."
            ],
            "decision_making": [
                "**🎯 최종 추정 질환**: 왼쪽 C6 목 신경뿌리병증(Cervical radiculopathy)",
                "**📍 병변 위치 추론 요약**: 감각 전도의 완전한 보존과 더불어, 서로 다른 말초신경 지배를 받으나 C6 척수 분절을 공유하는 다발 근육군 및 척추주위근의 침범이 뿌리 병변을 확증합니다.",
                "**💡 통합 물리치료 의사결정**: 경추 추간판 탈출이나 협착증 감별을 위해 MRI를 의뢰합니다. 기계적 압박을 줄이기 위해 목 견인치료(Traction)를 적용하고, 상지 방사통을 유발하는 자세를 피하도록 환자를 교육합니다."
            ],
            "differential": [
    ...
    # data/virtual_reports.py [Part 2/5]
    ...
    "오른쪽 온종아리신경병증 의심": {
        ...
        "interpretation": {
            "sensory": [
                "오른쪽 얕은종아리신경 감각 진폭이 정상(14 μV) 대비 크게 감소(4 μV)하여 말초 감각신경 손상을 확인합니다.",
                "인접한 장딴지신경 반응은 정상이므로 광범위한 다발신경병증이나 좌골신경 병변 가능성은 낮습니다."
            ],
            "motor": [
            ...
            "emg": [
                "종아리신경 지배 근육인 앞정강근 등에서 탈신경 소견이 관찰되나, 허리 척추주위근은 정상으로 신경뿌리 병변을 배제합니다."
            ],
            "decision_making": [
                "**🎯 최종 추정 질환**: 오른쪽 온종아리신경병증(Common peroneal neuropathy)",
                "**📍 병변 위치 추론 요약**: 종아리뼈머리 구간의 국소 전도차단, 얕은종아리신경 감각 소실, 척추주위근 보존 소견을 통해 종아리뼈머리 부위의 외부 압박 마비임을 확증합니다.",
                "**💡 통합 물리치료 의사결정**: 다리 꼬기 등 신경을 압박하는 습관을 즉각 중단시킵니다. 보행 시 발처짐(Foot drop)으로 인한 낙상을 방지하기 위해 단기적으로 발목 등굽힘 보조기(AFO)를 처방하고 보행 훈련을 병행합니다."
            ],
            "differential": [
    ...
    "왼쪽 L5 신경뿌리병증 의심": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 왼쪽 L5 허리 신경뿌리병증(Lumbar radiculopathy)",
                "**📍 병변 위치 추론 요약**: 감각 전도 보존 및 서로 다른 신경의 지배를 받는 L5 다발 근육군, 요추 척추주위근의 침근전도 이상을 종합하여 허리 신경뿌리 압박으로 확진합니다.",
                "**💡 통합 물리치료 의사결정**: 요추 MRI로 L4-L5 추간판 탈출 여부를 살피고 코어 안정화 및 윌리엄/맥켄지 운동을 환자 상태에 맞게 선별 적용합니다."
            ],
            "differential": [
    ...
    # data/virtual_reports.py [Part 3/5]
    ...
    "축삭성 다발신경병증 의심": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 길이의존성 축삭성 다발신경병증(Axonal polyneuropathy)",
                "**📍 병변 위치 추론 요약**: 양측 대칭적 장갑-양말형(Glove-stocking) 감각 둔화, 전신 신경 중 긴 신경 말단에서 가장 심한 진폭 감소가 도출되어 만성 축삭성 다발 손상임을 확증합니다.",
                "**💡 통합 물리치료 의사결정**: 환자의 당뇨(HbA1c) 등 대사성 원인 질환 관리가 필수적입니다. 감각 둔화로 인한 족부 궤양(당뇨발) 및 화상을 방지하는 보건 교육을 실시하고, 고유수용성 감각 저하를 보완하는 균형/낙상 방지 훈련을 적용합니다."
            ],
            "differential": [
    ...
    "급성 말이집탈락성 다발신경뿌리병증 의심": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 급성 염증성 말이집탈락성 다발신경뿌리병증(AIDP, 기얭-바레증후군)",
                "**📍 병변 위치 추론 요약**: 선행 감염력, 상행성 마비, 심각한 운동 전도속도 저하 및 근위부 신경뿌리를 대변하는 F파 소실을 근거로 다발성 탈말이집성 병변을 확증합니다.",
                "**💡 통합 물리치료 의사결정**: 급성 호흡근 마비 대비 폐활량(VC) 모니터링이 필수입니다. 피로를 유발하지 않는 선에서 관절구축 방지를 위한 수동 관절가동운동을 실시하며 회복 단계에 맞추어 점진적 재활을 계획합니다."
            ],
            "differential": [
    ...
    "오른쪽 팔꿈치굴증후군 의심": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 오른쪽 팔꿈치굴증후군(Cubital tunnel syndrome)",
                "**📍 병변 위치 추론 요약**: 팔꿈치 터널 구간에서의 명확한 전도 이상과 자신경 분포 내 국소 침범을 근거로 팔꿈치 주관 포착을 확진합니다.",
                "**💡 통합 물리치료 의사결정**: 야간 팔꿈치 신전 보조기를 착용하고, 턱 괴기나 컴퓨터 작업 시 팔꿈치 압박 회피 자세를 지도합니다."
            ],
            "differential": [
    ...
    # data/virtual_reports.py [Part 4/5]
    ...
    "왼쪽 상부위팔신경얼기병증 의심": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 왼쪽 위쪽 위팔신경얼기병증(Upper trunk brachial plexopathy)",
                "**📍 병변 위치 추론 요약**: 감각 감퇴, C5-C6 분지를 아우르는 복합 근육 마비, 하지만 목 척추주위근은 정상인 패턴을 종합해 상부 신경얼기 파열/손상을 확진합니다.",
                "**💡 통합 물리치료 의사결정**: Erb's point 주변 초음파 검사를 의뢰하며, 삼각근 마비로 인한 어깨 아탈구(Subluxation) 방지용 슬링(Sling)을 즉시 착용시킵니다."
            ],
            "differential": [
    ...
    "오른쪽 말초성 얼굴신경마비 의심": {
        ...
        "late_response": [
            {
                "test": "눈깜빡반사 오른쪽 자극-오른쪽 R1",
                "side": "오른쪽",
                "latency": "소실",
                "amplitude": "-"
            },
            {
                "test": "눈깜빡반사 오른쪽 자극-왼쪽 R2",
                "side": "왼쪽",
                "latency": "정상 범위",
                "amplitude": "보존"
            },
            {
                "test": "눈깜빡반사 왼쪽 자극-왼쪽 R1",
                "side": "왼쪽",
                "latency": "정상 범위",
                "amplitude": "보존"
            }
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 오른쪽 말초성 안면신경마비(Bell's palsy)",
                "**📍 병변 위치 추론 요약**: 이마 주름 소실(말초성 징후), 안면 운동 진폭 급감 및 우측 자극 시의 반사 차단을 결합해 뇌신경 7번의 말초 가지 손상으로 진단합니다.",
                "**💡 통합 물리치료 의사결정**: 눈이 안 감겨 발생할 수 있는 안구 건조 및 각막 궤양 예방을 위해 안대와 인공눈물을 적용합니다. 연합운동을 피하면서 거울을 이용한 바이오피드백 표정근 운동을 지도합니다."
            ],
            "differential": [
    ...
    "뇌졸중 후 경직 H-반사 평가": {
        ...
        "interpretation": {
            ...
            "decision_making": [
                "**🎯 최종 추정 질환**: 중추성 마비 기인 왼쪽 하지 경직(Spasticity)",
                "**📍 병변 위치 추론 요약**: 비정상적 H-반사 항진 및 높은 H/M 비율은 상위운동신경원(UMN) 병변으로 인한 척수 억제 상실의 객관적 증거가 됩니다.",
                "**💡 통합 물리치료 의사결정**: MAS 평가 기준에 맞추어 장딴지근 지속적 스트레칭 및 체중부하 운동을 실시합니다. 대항근인 앞정강근에 기능적전기자극(FES)을 가하는 상호억제 기법을 적극 활용합니다."
            ],
            "differential": [
