...
VIRTUAL_REPORTS = {
    ...
    "2. 오른쪽 1~3번째 손가락 저림 (손목굴증후군)": {
        ...
        "ncs_sensory": [
            ["정중신경", "오른쪽", "9 μV (감소)", "4.9 ms (지연)", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "왼쪽", "26 μV", "2.7 ms", "정상 범위"],
            ["자신경", "오른쪽", "24 μV", "2.5 ms", "정상 범위"],
            ["노신경", "오른쪽", "20 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["정중신경", "손목", "오른쪽", "4.5 mV (감소)", "5.8 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "팔꿈치", "오른쪽", "4.2 mV (감소)", "9.5 ms (지연)", "51 m/s", "비정상 (손목 지연 지속)"],
    ...
    "4. 오른쪽 4~5번째 손가락 저림 (팔꿈치굴증후군)": {
        ...
        "ncs_sensory": [
            ["자신경", "오른쪽", "9 μV (감소)", "3.4 ms (지연)", "비정상 (진폭 감소 / 잠복기 지연)"],
        ...
        "emg": [
            ...
            ["깊은손가락굽힘근", "C8-T1", "오른쪽", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
    ...
    "5. 오른쪽 손목처짐 및 손등 감각 저하 (노신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["노신경", "나선고랑 위", "오른쪽", "1.5 mV (급감)", "10.1 ms (지연)", "21 m/s (저하)", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
    ...
    "7. 왼쪽 발처짐 및 발목 바깥쪽 무딤 (온종아리신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["종아리신경", "오금", "왼쪽", "1.2 mV (급감)", "14.5 ms (지연)", "22 m/s (저하)", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
    ...
    "8. 오른쪽 어깨 통증 및 어깨세모근 약화 (C7 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ["정중신경", "오른쪽", "28 μV", "2.7 ms", "정상 범위"],
            ["정중신경", "왼쪽", "29 μV", "2.6 ms", "정상 범위"],
            ["자신경", "오른쪽", "24 μV", "2.4 ms", "정상 범위"],
    ...
    "9. 왼쪽 갑작스러운 얼굴 마비 (벨마비)": {
        ...
        "ncs_motor": [
            ["얼굴신경 코근", "귀앞", "왼쪽", "0.8 mV (감소)", "4.5 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["얼굴신경 코근", "귀앞", "오른쪽", "3.5 mV", "2.8 ms", "-", "정상 범위"],
            ["얼굴신경 눈둘레근", "귀앞", "왼쪽", "0.6 mV (감소)", "4.2 ms (지연)", "-", "비정상 (진폭 감소)"],
    ...
    "10. 양측 발바닥 저림 및 통증 (다발신경병증)": {
        ...
        "ncs_sensory": [
            ["장딴지신경", "오른쪽", "무반응 (소실)", "측정불가", "비정상 (반응 소실)"],
            ["장딴지신경", "왼쪽", "무반응 (소실)", "측정불가", "비정상 (반응 소실)"],
            ["얕은종아리신경", "오른쪽", "무반응 (소실)", "측정불가", "비정상 (반응 소실)"],
            ["얕은종아리신경", "왼쪽", "무반응 (소실)", "측정불가", "비정상 (반응 소실)"],
            ["정중신경", "오른쪽", "12 μV (감소)", "3.8 ms (지연)", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "왼쪽", "13 μV (감소)", "3.7 ms (지연)", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["자신경", "오른쪽", "14 μV (감소)", "3.1 ms", "비정상 (진폭 감소)"],
            ["자신경", "왼쪽", "15 μV (감소)", "3.0 ms", "비정상 (진폭 감소)"],
        ],
        "ncs_motor": [
            ["정강신경", "발목", "오른쪽", "1.8 mV (감소)", "6.2 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "오금", "오른쪽", "1.5 mV", "15.8 ms", "38 m/s (저하)", "비정상 (전도속도 저하)"],
            ["정강신경", "발목", "왼쪽", "1.7 mV (감소)", "6.4 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "오금", "왼쪽", "1.4 mV", "16.1 ms", "37 m/s (저하)", "비정상 (전도속도 저하)"],
            ["종아리신경", "발목", "오른쪽", "2.1 mV (감소)", "5.8 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "종아리뼈머리 아래", "오른쪽", "1.8 mV", "14.5 ms", "39 m/s (저하)", "비정상 (전도속도 저하)"],
            ["종아리신경", "발목", "왼쪽", "2.0 mV (감소)", "5.9 ms (지연)", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "종아리뼈머리 아래", "왼쪽", "1.7 mV", "14.8 ms", "38 m/s (저하)", "비정상 (전도속도 저하)"],
