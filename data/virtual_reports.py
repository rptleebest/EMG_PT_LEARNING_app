...
VIRTUAL_REPORTS = {
    "1. 왼쪽 목 통증 및 엄지/검지 저림 (C6 신경뿌리병증)": {
        ...
        "emg": [
            ...
            ["위팔두갈래근 (Biceps brachii)", "C5-C6", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경/동원감소)"],
            ["원엎침근 (Pronator teres)", "C6-C7", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경/동원감소)"],
            ["위팔세갈래근 (Triceps brachii)", "C7-C8", "왼쪽(Lt)", "Silent", "Normal recruitment", "정상"],
        ],
        "teaching_diagnosis": {
            "summary": "왼쪽 C6 목 신경뿌리병증",
            "ncs_reason": [
                "정중신경과 자신경의 감각(SNAP)과 운동(CMAP) 전도가 좌우측 모두 정상 범위입니다.",
                "감각신경 진폭이 보존된 것은 병변이 감각신경 세포체(DRG)보다 중추측인 척수 신경뿌리(Root)에 있음을 의미합니다."
            ],
            "emg_reason": [
                "위팔두갈래근(근육피부신경)과 원엎침근(정중신경) 등 여러 말초신경 지배 근육에서 비정상 탈신경 전위가 발견되어 단일 신경 병변이 아님을 확인합니다.",
                "C6 척추주위근 탈신경 소견은 병변이 척수 신경뿌리에 위치함을 확진합니다."
            ],
            "integration": [
                "정상 감각전도와 C6 신경절 지배 다수 근육 및 척추주위근의 침범 소견을 통합하여 C6 목 신경뿌리병증으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "근육피부신경병증 (Musculocutaneous Neuropathy)",
                "why_consider": "위팔두갈래근 약화와 엄지/검지 쪽 감각 이상이 C6 병변과 유사합니다.",
                "how_to_differentiate": "말초신경병증이라면 원엎침근(정중신경 지배)과 척추주위근은 정상이어야 하며 감각 전도가 감소해야 합니다."
            }
        ]
    },
    ...
    "2. 오른쪽 1~3번째 손가락 저림 (손목굴증후군)": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "정중신경 감각/운동 전도에서만 잠복기가 뚜렷하게 지연되어 손목굴 내 국소 말이집탈락(Demyelination)을 지시합니다.",
                "자신경은 양측 모두 정상 수치를 보여 병변이 정중신경에 국한됨을 증명합니다."
            ],
            "emg_reason": [
                "정중신경 지배인 APB에서 탈신경 전위가 없는 것은 심한 축삭 손상까지는 이르지 않은 경도~중등도 상태임을 의미합니다.",
                "손목 상부의 정중신경 지배 근육인 원엎침근(PT)이 정상인 것은 병변이 손목 수준임을 확인시켜 줍니다."
            ],
            "integration": [
                "오른쪽 정중신경에 국한된 명확한 잠복기 지연과, 손목 상위 근육의 정상 소견을 통합하여 손목굴증후군으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "원엎침근증후군이라면 손목 부위의 잠복기 지연이 두드러지지 않으며, EMG에서 손목 상부 근육인 원엎침근에 비정상 소견이 나타나야 합니다."
            }
        ]
    },
    ...
    "3. 왼쪽 허리/엉치 통증 및 발처짐 (L5 신경뿌리병증)": {
        ...
        "emg": [
            ["허리 척추주위근 (Lumb. Paraspinal)", "L5", "왼쪽(Lt)", "Fibrillation/PSW", "통증으로 평가불가", "비정상 (탈신경)"],
            ["앞정강근 (Tibialis anterior)", "L4-L5", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경/동원감소)"],
            ["긴종아리근 (Peroneus longus)", "L5-S1", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경/동원감소)"],
            ["안쪽장딴지근 (Med. Gastrocnemius)", "S1-S2", "왼쪽(Lt)", "Silent", "Normal recruitment", "정상"],
        ],
        "teaching_diagnosis": {
            "summary": "왼쪽 L5 허리 신경뿌리병증",
            "ncs_reason": [
                "발처짐과 감각 이상이 있음에도 얕은종아리신경 SNAP 진폭이 정상인 것은 병변이 DRG 몸쪽인 L5 척수 신경뿌리에 위치함을 증명합니다."
            ],
            "emg_reason": [
                "깊은종아리신경 지배(앞정강근)와 얕은종아리신경 지배(긴종아리근) 근육 모두에서 탈신경 전위가 발견되어 단일 신경 마비가 아님을 시사합니다.",
                "L5 허리 척추주위근의 비정상 자발전위는 병변이 말초가 아닌 척추 측에 있음을 확진합니다."
            ],
            "integration": [
                "감각전도 보존, L5 지배 다수 말초 근육 침범, 척추주위근 탈신경 전위 출현을 통합하여 L5 신경뿌리병증으로 결론 내립니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "온종아리신경 마비 (Common Peroneal Neuropathy)",
                "why_consider": "발처짐(Foot drop)과 종아리 가쪽 감각 저하가 L5 신경뿌리병증과 거의 동일합니다.",
                "how_to_differentiate": "온종아리신경 마비라면 얕은종아리신경 SNAP 진폭이 감소하며, 허리 척추주위근 EMG는 반드시 정상이어야 합니다."
            }
        ]
    },
    ...
    "4. 오른쪽 4~5번째 손가락 저림 (팔꿈치굴증후군)": {
        ...
        "ncs_motor": [
            ...
            ["자신경(Ulnar)", "팔꿈치 위(Above)", "오른쪽(Rt)", "3.1 mV", "8.2 ms", "비정상 (국소전도차단)"],
        ],
        "emg": [
            ["새끼벌림근 (ADM)", "C8-T1 (자신경)", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["첫째등쪽뼈사이근 (FDI)", "C8-T1 (자신경)", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["짧은엄지벌림근 (APB)", "C8-T1 (정중)", "오른쪽(Rt)", "Silent", "Normal recruitment", "정상"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "자신경 감각전도 지연 및 진폭 감소가 확인됩니다.",
                "팔꿈치 위/아래를 자극했을 때 진폭이 50% 이상 급감하는 '전도차단(Conduction Block)' 현상이 관찰되어 팔꿈치 부위 압박을 확진합니다."
            ],
            "emg_reason": [
                "자신경 지배 근육인 ADM과 FDI에서 탈신경 전위가 확인되어 축삭 손상이 동반되었음을 알 수 있습니다.",
                "동일한 C8-T1 분절 지배를 받지만 정중신경 지배인 APB와 척추주위근이 정상인 것은 척수 신경뿌리병증을 완벽히 배제합니다."
            ],
            "integration": [
                "자신경에 국한된 팔꿈치 부위 전도차단과 해당 근육의 축삭 손상을 종합하여 팔꿈치굴증후군으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "C8 신경뿌리병증 (C8 Radiculopathy)",
                "why_consider": "손 내재근(아귀힘) 약화 및 손날 부위 저림이 매우 유사합니다.",
                "how_to_differentiate": "C8 신경뿌리병증이라면 정중신경 지배 근육(APB)도 함께 약화/탈신경되며, 감각 전도(SNAP)는 정상으로 보존되어야 합니다."
            }
        ]
    },
    ...
    "5. 오른쪽 손목처짐 및 손등 감각 저하 (요골신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["노신경(Radial)", "나선고랑 위(Spiral G.)", "오른쪽(Rt)", "1.5 mV", "7.1 ms", "비정상 (국소전도차단)"],
        ],
        "emg": [
            ["긴노쪽손목폄근 (ECRL)", "C6-C7 (노신경)", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "표재노신경 감각전도 진폭 감소와 함께, 운동신경 자극 시 나선고랑 상하부 사이에서 심한 전도차단(Conduction Block)이 관찰되어 물리적 압박 위치를 지시합니다."
            ],
            "emg_reason": [
                "나선고랑 하부에서 신경 지배를 받는 손목폄근과 손가락폄근은 탈신경 소견을 보입니다.",
                "나선고랑 상부에서 분지되는 위팔세갈래근(Triceps)이 정상인 것은 병변이 겨드랑이나 목이 아님을 해부학적으로 증명합니다."
            ],
            "integration": [
                "위팔세갈래근의 보존, 나선고랑 부위 전도차단, 하부 폄근들의 마비를 통합하여 나선고랑 부위 요골신경 마비로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "후골간신경 마비는 순수 운동신경 마비이므로 감각 소실이 없으며 표재노신경 SNAP이 정상이어야 합니다."
            }
        ]
    },
    ...
    "6. 오른쪽 엉치 방사통 및 종아리 약화 (S1 신경뿌리병증)": {
        ...
        "emg": [
            ["안쪽장딴지근 (Med. Gastrocnemius)", "S1-S2", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["가자미근 (Soleus)", "S1-S2", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["큰볼기근 (Gluteus maximus)", "S1-S2", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "종아리 뒤쪽/발바닥 감각 이상이 있음에도 장딴지신경(Sural) SNAP가 정상으로 보존되는 전형적인 척수 신경뿌리(DRG 몸쪽) 병변 양상입니다."
            ],
            "emg_reason": [
                "정강신경 지배(장딴지근, 가자미근)와 하볼기신경 지배(큰볼기근) 등 각기 다른 말초신경의 지배를 받으나 S1 분절을 공유하는 근육들에서 동시 탈신경이 확인됩니다.",
                "척추주위근 탈신경 소견은 병변이 말초가 아닌 척수 근위부임을 확진합니다."
            ],
            "integration": [
                "장딴지신경 전도 보존 및 S1 분절 우세 근육/척추주위근 탈신경을 통합하여 S1 신경뿌리병증으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "궁둥신경병증 (Sciatic Neuropathy)",
                "why_consider": "다리 뒤쪽 통증과 약화가 S1 증상과 완벽히 겹칩니다.",
                "how_to_differentiate": "말초 궁둥신경이 눌렸다면 장딴지신경 감각전도 진폭이 유의하게 감소하며, 허리 척추주위근은 정상이어야 합니다."
            }
        ]
    },
    ...
    "7. 왼쪽 발처짐 및 종아리 가쪽 무딤 (온종아리신경 마비)": {
        ...
        "ncs_motor": [
            ...
            ["종아리신경(Peroneal)", "종아리뼈머리(Fib. Head)", "왼쪽(Lt)", "1.2 mV", "8.5 ms", "비정상 (국소전도차단)"],
        ],
        "emg": [
            ["앞정강근 (Tibialis anterior)", "L4-L5 (깊은종아리)", "왼쪽(Lt)", "Silent", "No recruitment", "비정상 (전도완전마비)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "얕은종아리신경 감각전도가 저하되었고, 운동전도 검사에서 종아리뼈머리를 지날 때 급격한 진폭 감소(전도차단)가 확인되어 물리적 압박 위치가 특정됩니다."
            ],
            "emg_reason": [
                "종아리뼈머리 아래에 위치한 앞정강근과 긴종아리근은 운동단위 동원이 안되거나 감소합니다.",
                "무릎 위쪽에서 분지되는 넙다리두갈래근(짧은갈래)과 척추주위근이 정상인 것은 궁둥신경이나 척추 뿌리 문제가 아님을 해부학적으로 입증합니다."
            ],
            "integration": [
                "국소 전도차단과 무릎 하부 폄근/벌림근의 선택적 마비를 통합하여 온종아리신경 마비로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "L5 병변이라면 감각전도(SNAP)가 대칭적으로 정상이어야 하며, 무릎 위의 근육(TFL, 중둔근)과 척추주위근에서 비정상 소견이 나타나야 합니다."
            }
        ]
    },
    ...
    "8. 오른쪽 어깨/팔 뻐근함 및 삼두근 약화 (C7 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ["정중신경 3지(Median 3rd D.)", "오른쪽(Rt)", "28 μV", "2.7 ms", "정상 (DRG 보존)"],
        ...
        "emg": [
            ["목 척추주위근 (Cerv. Paraspinal)", "C7", "오른쪽(Rt)", "Fibrillation/PSW", "통증으로 평가불가", "비정상 (탈신경)"],
            ["위팔세갈래근 (Triceps brachii)", "C7-C8 (노신경)", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경/동원감소)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "가운데 손가락 저림이 뚜렷함에도 정중신경 3지 SNAP 진폭이 정상으로 유지되는 전형적인 척수 신경뿌리(근위부) 병변입니다."
            ],
            "emg_reason": [
                "C7 분절의 주요 지배를 받는 위팔세갈래근(노신경), 노쪽손목굽힘근(정중신경)에서 동시 탈신경이 확인되어 말초 단일 신경 문제가 아님을 입증합니다.",
                "C7 척추주위근 탈신경 소견과, C5-6 지배인 위팔두갈래근의 정상 소견은 병변이 C7 레벨에 국한됨을 확진합니다."
            ],
            "integration": [
                "감각전도 보존, C7 우세 다수 말초근육 동시 침범, 척추주위근 침범을 통합하여 C7 신경뿌리병증으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "요골신경 마비라면 정중신경 지배를 받는 노쪽손목굽힘근(FCR)이나 척추주위근은 정상이어야 합니다. C7 병변은 여러 신경에 걸쳐 C7 분절만 약화시킵니다."
            }
        ]
    },
    ...
    "9. 왼쪽 갑작스러운 안면 마비 (벨마비)": {
        ...
        "emg": [
            ["눈둘레근 (Orbicularis oculi)", "얼굴신경(CN VII)", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["깨물근 (Masseter)", "삼차신경(CN V)", "왼쪽(Lt)", "Silent", "Normal recruitment", "정상"],
        ],
        "teaching_diagnosis": {
            "summary": "왼쪽 말초성 얼굴신경마비 (벨마비)",
            "ncs_reason": [
                "감각을 담당하는 삼차신경(V1)은 정상이나, 안면 근육의 운동을 담당하는 얼굴신경 CMAP 진폭이 건측(오른쪽) 대비 25% 이하로 급감하여 심각한 축삭 변성을 시사합니다."
            ],
            "emg_reason": [
                "발병 후 충분한 시간(약 2~3주)이 지나 눈둘레근에서 비정상 자발전위(탈신경)가 뚜렷하게 관찰됩니다.",
                "저작근(삼차신경 지배)은 정상이므로 뇌줄기 등 중추성 복합 뇌신경 마비가 아님을 확인합니다."
            ],
            "integration": [
                "이마 주름 소실, 얼굴신경 단독의 심한 진폭 감소 및 탈신경 소견을 통합하여 전형적인 말초성 벨마비로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "대뇌 피질은 이마 근육(상부)에 양측성 지배를 하므로, 중추성 뇌졸중 환자는 마비측 이마에 주름을 잡을 수 있습니다. 반면 벨마비(말초성)는 이마 주름조차 짓지 못합니다."
            }
        ]
    },
    ...
    "10. 양측 발끝 저림 및 감각 소실 (다발신경병증)": {
        ...
        "emg": [
            ["앞정강근 (Tibialis ant.)", "L4-L5", "오른쪽(Rt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
            ["앞정강근 (Tibialis ant.)", "L4-L5", "왼쪽(Lt)", "Fibrillation/PSW", "Reduced recruitment", "비정상 (탈신경)"],
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "가장 긴 신경인 양측 다리 장딴지신경(Sural)에서 반응이 소실되고, 상대적으로 짧은 상지 정중신경은 반응이 남아있으나 진폭이 감소한 전형적인 길이의존성 패턴입니다.",
                "대칭적인 광범위 진폭 감소는 전신적인 대사성/독성 원인에 의한 축삭 퇴행을 의미합니다."
            ],
            "emg_reason": [
                "다리 원위부 근육인 양측 앞정강근에서 대칭적인 탈신경 전위가 확인됩니다.",
                "상지 근위부 근육인 위팔두갈래근은 정상인 것을 볼 때, 몸에서 가장 먼 신경 말단부터 서서히 퇴행(Dying-back)하는 기전임을 확증합니다."
            ],
            "integration": [
                "양측 다리 감각/운동 전도 대칭적 소실, 원위부 우세 EMG 이상 소견을 통합하여 전신성 다발신경병증으로 결론 내립니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "협착증에 의한 다발 뿌리병증은 말초 감각전도(SNAP)가 대부분 보존되며, EMG 상 허리 척추주위근에 양측성 탈신경 소견이 뚜렷해야 합니다. 반면 다발신경병증은 SNAP 소실이 핵심입니다."
            }
        ]
    }
}
