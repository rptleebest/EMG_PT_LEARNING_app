...
VIRTUAL_REPORTS = {
    "왼쪽 목 통증 및 엄지/검지 저림 (C6 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ...
            ["자신경", "정상측(Rt)", "22 μV", "2.5 ms", "정상 범위"],
            ["자신경", "병변측(Lt)", "21 μV", "2.6 ms", "정상 범위"],
            ["노신경", "병변측(Lt)", "18 μV", "2.1 ms", "정상 범위"],
            ["가쪽아래팔피부신경", "병변측(Lt)", "20 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["정중신경", "손목", "정상측(Rt)", "8.5 mV", "3.5 ms", "-", "정상 범위"],
            ["정중신경", "손목", "병변측(Lt)", "8.2 mV", "3.6 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "정상측(Rt)", "8.2 mV", "7.2 ms", "54 m/s", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Lt)", "7.9 mV", "7.4 ms", "53 m/s", "정상 범위"],
            ["자신경", "손목", "정상측(Rt)", "7.5 mV", "2.8 ms", "-", "정상 범위"],
            ["자신경", "손목", "병변측(Lt)", "7.3 mV", "2.9 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "정상측(Rt)", "7.2 mV", "6.5 ms", "57 m/s", "정상 범위"],
            ["자신경", "팔꿈치 아래", "병변측(Lt)", "7.0 mV", "6.7 ms", "56 m/s", "정상 범위"],
            ["노신경", "아래팔", "병변측(Lt)", "6.5 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "병변측(Lt)", "6.1 mV", "5.1 ms", "62 m/s", "정상 범위"],
            ["근육피부신경", "위팔", "병변측(Lt)", "5.8 mV", "2.1 ms", "-", "정상 범위"],
            ["근육피부신경", "겨드랑이", "병변측(Lt)", "5.4 mV", "4.8 ms", "60 m/s", "정상 범위"],
        ],
        "emg": [
            ["목 척추주위근 (좌)", "C5", "Silent", "Normal recruitment", "정상 범위"],
            ["목 척추주위근 (좌)", "C6", "Fibrillation/PSW", "통증으로 평가 불가", "비정상 (활동성 탈신경)"],
            ["목 척추주위근 (좌)", "C7", "Silent", "Normal recruitment", "정상 범위"],
            ["어깨세모근 (좌)", "C5-C6", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔두갈래근 (좌)", "C5-C6", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["위팔노근 (좌)", "C5-C6", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["원엎침근 (좌)", "C6-C7", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["노쪽손목굽힘근 (좌)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔세갈래근 (좌)", "C7-C8", "Silent", "Normal recruitment", "정상 범위"],
            ["손가락폄근 (좌)", "C7-C8", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
    ...
    "오른쪽 1~3번째 손가락 저림 (손목굴증후군)": {
        "info": {"age": 52, "sex": "여성", "symptom": "오른손 엄지~중지 저림, 야간 통증 및 손목 굽힘 시 증상 악화", "side": "Rt"},
        "ncs_sensory": [
            ["정중신경", "정상측(Lt)", "26 μV", "2.7 ms", "정상 범위"],
            ["정중신경", "병변측(Rt)", "9 μV", "4.9 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["자신경", "병변측(Rt)", "24 μV", "2.5 ms", "정상 범위"],
            ["노신경", "병변측(Rt)", "20 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["정중신경", "손목", "정상측(Lt)", "8.1 mV", "3.6 ms", "-", "정상 범위"],
            ["정중신경", "손목", "병변측(Rt)", "4.5 mV", "5.8 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "팔꿈치", "정상측(Lt)", "7.8 mV", "7.4 ms", "53 m/s", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Rt)", "4.2 mV", "9.5 ms", "51 m/s", "비정상 (손목 지연 지속)"],
            ["자신경", "손목", "병변측(Rt)", "7.6 mV", "2.9 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "병변측(Rt)", "7.4 mV", "6.5 ms", "58 m/s", "정상 범위"],
            ["노신경", "아래팔", "병변측(Rt)", "6.8 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "병변측(Rt)", "6.5 mV", "5.2 ms", "62 m/s", "정상 범위"],
        ],
        "emg": [
            ["목 척추주위근 (우)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
            ["원엎침근 (우)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
            ["노쪽손목굽힘근 (우)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
            ["짧은엄지벌림근 (우)", "C8-T1", "Silent", "Normal recruitment", "정상 범위"],
            ["첫째등쪽뼈사이근 (우)", "C8-T1", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
            "summary": "Rt 손목굴증후군 (Carpal Tunnel Syndrome)",
            "ncs_reason": [
                "Rt 정중신경 감각 및 운동 신경에서만 잠복기가 뚜렷하게 지연되어 손목굴 부위 압박을 지시합니다.",
    ...
    "왼쪽 허리/엉치 통증 및 발처짐 (L5 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ...
            ["장딴지신경", "정상측(Rt)", "18 μV", "3.0 ms", "정상 범위"],
            ["장딴지신경", "병변측(Lt)", "17 μV", "3.1 ms", "정상 범위"],
            ["두렁신경", "병변측(Lt)", "12 μV", "3.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["종아리신경", "발목", "정상측(Rt)", "4.8 mV", "4.2 ms", "-", "정상 범위"],
            ["종아리신경", "발목", "병변측(Lt)", "4.5 mV", "4.5 ms", "-", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "정상측(Rt)", "4.6 mV", "9.8 ms", "50 m/s", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "병변측(Lt)", "4.3 mV", "10.2 ms", "48 m/s", "정상 범위"],
            ["정강신경", "발목", "병변측(Lt)", "5.5 mV", "5.0 ms", "-", "정상 범위"],
            ["정강신경", "오금", "병변측(Lt)", "5.2 mV", "13.5 ms", "45 m/s", "정상 범위"],
            ["넓적다리신경", "무릎 위", "병변측(Lt)", "6.2 mV", "4.1 ms", "-", "정상 범위"],
            ["넓적다리신경", "고샅부위", "병변측(Lt)", "6.0 mV", "8.5 ms", "52 m/s", "정상 범위"],
        ],
        "emg": [
            ["허리 척추주위근 (좌)", "L4", "Silent", "Normal recruitment", "정상 범위"],
            ["허리 척추주위근 (좌)", "L5", "Fibrillation/PSW", "통증으로 평가 불가", "비정상 (활동성 탈신경)"],
            ["허리 척추주위근 (좌)", "S1", "Silent", "Normal recruitment", "정상 범위"],
            ["엉덩허리근 (좌)", "L2-L3", "Silent", "Normal recruitment", "정상 범위"],
            ["가쪽넓은근 (좌)", "L3-L4", "Silent", "Normal recruitment", "정상 범위"],
            ["앞정강근 (좌)", "L4-L5", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["긴종아리근 (좌)", "L5-S1", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["넓적다리근막긴장근 (좌)", "L4-L5", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["안쪽장딴지근 (좌)", "S1-S2", "Silent", "Normal recruitment", "정상 범위"],
            ["큰볼기근 (좌)", "S1-S2", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
    ...
    "오르녹 4~5번째 손가락 저림 (팔꿈치굴증후군)": {
        "info": {"age": 42, "sex": "남성", "symptom": "Rt 새끼손가락 저림, 젓가락질 불편 및 손아귀 힘 약화", "side": "Rt"},
        "ncs_sensory": [
            ["자신경", "정상측(Lt)", "22 μV", "2.5 ms", "정상 범위"],
            ["자신경", "병변측(Rt)", "9 μV", "3.4 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "병변측(Rt)", "24 μV", "2.8 ms", "정상 범위"],
            ["안쪽아래팔피부신경", "병변측(Rt)", "20 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["자신경", "팔꿈치 아래", "병변측(Rt)", "7.2 mV", "3.0 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 위", "병변측(Rt)", "3.1 mV", "8.2 ms", "23 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정중신경", "손목", "병변측(Rt)", "8.5 mV", "3.5 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Rt)", "8.2 mV", "7.2 ms", "54 m/s", "정상 범위"],
        ],
        "emg": [
            ["목 척추주위근 (우)", "C8-T1", "Silent", "Normal recruitment", "정상 범위"],
            ["자쪽손목굽힘근 (우)", "C7-C8", "Silent", "Normal recruitment", "정상 범위"],
            ["깊은손가락굽힘근 (우)", "C8-T1", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["새끼벌림근 (우)", "C8-T1", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["첫째등쪽뼈사이근 (우)", "C8-T1", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["짧은엄지벌림근 (우)", "C8-T1", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
    ...
    "오른쪽 손목처짐 및 손등 감각 저하 (노신경 마비)": {
        "info": {"age": 34, "sex": "남성", "symptom": "음주 후 의자에서 팔을 누른 채 잔 후 우측 손목처짐 및 손등 저림 발생", "side": "Rt"},
        "ncs_sensory": [
            ["노신경", "정상측(Lt)", "20 μV", "2.1 ms", "정상 범위"],
            ["노신경", "병변측(Rt)", "8 μV", "3.2 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["가쪽아래팔피부신경", "병변측(Rt)", "19 μV", "2.2 ms", "정상 범위"],
            ["정중신경", "병변측(Rt)", "25 μV", "2.8 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["노신경", "아래팔", "병변측(Rt)", "6.8 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "병변측(Rt)", "6.5 mV", "5.2 ms", "60 m/s", "정상 범위"],
            ["노신경", "나선고랑 위", "병변측(Rt)", "1.5 mV", "10.1 ms", "21 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정중신경", "손목", "병변측(Rt)", "8.2 mV", "3.4 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Rt)", "7.9 mV", "7.1 ms", "55 m/s", "정상 범위"],
        ],
        "emg": [
            ["목 척추주위근 (우)", "C7-C8", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔세갈래근 (우)", "C7-C8", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔노근 (우)", "C5-C6", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["긴노쪽손목폄근 (우)", "C6-C7", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["손가락폄근 (우)", "C7-C8", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["원엎침근 (우)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
            ["노쪽손목굽힘근 (우)", "C6-C7", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
    ...
    "오른쪽 엉덩이 통증 및 까치발 보행 어려움 (S1 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ...
            ["얕은종아리신경", "병변측(Rt)", "14 μV", "2.8 ms", "정상 범위"],
            ["두렁신경", "병변측(Rt)", "11 μV", "3.3 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["정강신경", "발목", "정상측(Lt)", "6.4 mV", "4.7 ms", "-", "정상 범위"],
            ["정강신경", "발목", "병변측(Rt)", "6.1 mV", "4.8 ms", "-", "정상 범위"],
            ["정강신경", "오금", "정상측(Lt)", "6.1 mV", "14.0 ms", "49 m/s", "정상 범위"],
            ["정강신경", "오금", "병변측(Rt)", "5.8 mV", "14.2 ms", "48 m/s", "정상 범위"],
            ["종아리신경", "발목", "병변측(Rt)", "5.2 mV", "4.1 ms", "-", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "병변측(Rt)", "5.0 mV", "10.0 ms", "46 m/s", "정상 범위"],
        ],
        "emg": [
            ["허리 척추주위근 (우)", "L5", "Silent", "Normal recruitment", "정상 범위"],
            ["허리 척추주위근 (우)", "S1", "Fibrillation/PSW", "통증으로 평가 불가", "비정상 (활동성 탈신경)"],
            ["가쪽넓은근 (우)", "L3-L4", "Silent", "Normal recruitment", "정상 범위"],
            ["앞정강근 (우)", "L4-L5", "Silent", "Normal recruitment", "정상 범위"],
            ["안쪽장딴지근 (우)", "S1-S2", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["가자미근 (우)", "S1-S2", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["큰볼기근 (우)", "S1-S2", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
        ],
        "teaching_diagnosis": {
    ...
    "왼쪽 발처짐 및 발목 바깥쪽 무딤 (온종아리신경 마비)": {
        "info": {"age": 28, "sex": "여성", "symptom": "타이트한 부츠를 장시간 착용한 후 Lt 발목이 안 들리고 발등 감각이 무딤", "side": "Lt"},
        "ncs_sensory": [
            ["얕은종아리신경", "정상측(Rt)", "16 μV", "2.8 ms", "정상 범위"],
            ["얕은종아리신경", "병변측(Lt)", "6 μV", "4.1 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["장딴지신경", "병변측(Lt)", "18 μV", "3.1 ms", "정상 범위"],
            ["두렁신경", "병변측(Lt)", "13 μV", "3.0 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["종아리신경", "발목", "병변측(Lt)", "5.1 mV", "4.0 ms", "-", "정상 범위"],
            ["종아리신경", "종아리뼈머리 아래", "병변측(Lt)", "4.8 mV", "10.0 ms", "45 m/s", "정상 범위"],
            ["종아리신경", "오금", "병변측(Lt)", "1.2 mV", "14.5 ms", "22 m/s", "비정상 (진폭 급감 / 국소 전도차단 의심)"],
            ["정강신경", "발목", "병변측(Lt)", "6.2 mV", "4.5 ms", "-", "정상 범위"],
            ["정강신경", "오금", "병변측(Lt)", "5.9 mV", "13.5 ms", "48 m/s", "정상 범위"],
        ],
        "emg": [
            ["허리 척추주위근 (좌)", "L5", "Silent", "Normal recruitment", "정상 범위"],
            ["넓적다리두갈래근 짧은갈래 (좌)", "L5-S1", "Silent", "Normal recruitment", "정상 범위"],
            ["앞정강근 (좌)", "L4-L5", "Silent", "Reduced recruitment", "비정상 (동원 감소)"],
            ["긴종아리근 (좌)", "L5-S1", "Silent", "Reduced recruitment", "비정상 (동원 감소)"],
            ["넓적다리근막긴장근 (좌)", "L4-L5", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
    ...
    "오른쪽 어깨 통증 및 어깨세모근 약화 (C7 신경뿌리병증)": {
        ...
        "ncs_sensory": [
            ...
            ["자신경", "병변측(Rt)", "24 μV", "2.4 ms", "정상 범위"],
            ["노신경", "병변측(Rt)", "19 μV", "2.2 ms", "정상 범위"],
        ],
        "ncs_motor": [
            ["노신경", "아래팔", "병변측(Rt)", "7.1 mV", "2.5 ms", "-", "정상 범위"],
            ["노신경", "팔꿈치", "병변측(Rt)", "6.9 mV", "5.1 ms", "62 m/s", "정상 범위"],
            ["정중신경", "손목", "병변측(Rt)", "8.8 mV", "3.2 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Rt)", "8.5 mV", "7.0 ms", "55 m/s", "정상 범위"],
            ["자신경", "손목", "병변측(Rt)", "7.5 mV", "2.8 ms", "-", "정상 범위"],
            ["자신경", "팔꿈치 아래", "병변측(Rt)", "7.2 mV", "6.4 ms", "57 m/s", "정상 범위"],
        ],
        "emg": [
            ["목 척추주위근 (우)", "C6", "Silent", "Normal recruitment", "정상 범위"],
            ["목 척추주위근 (우)", "C7", "Fibrillation/PSW", "통증으로 평가 불가", "비정상 (활동성 탈신경)"],
            ["목 척추주위근 (우)", "C8", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔두갈래근 (우)", "C5-C6", "Silent", "Normal recruitment", "정상 범위"],
            ["노쪽손목굽힘근 (우)", "C6-C7", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["위팔세갈래근 (우)", "C7-C8", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["손가락폄근 (우)", "C7-C8", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["짧은엄지벌림근 (우)", "C8-T1", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
            "summary": "Rt C7 목 신경뿌리병증 (Cervical Radiculopathy)",
            "ncs_reason": [
    ...
    "왼쪽 갑작스러운 얼굴 마비 (벨마비)": {
        "info": {"age": 35, "sex": "여성", "symptom": "자고 일어난 후 Lt 얼굴 근육이 움직이지 않고 눈이 안 감김, 이마 주름 잡기 불가", "side": "Lt"},
        "ncs_sensory": [
        ...
        "emg": [
            ["눈둘레근 (좌)", "얼굴신경", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["입둘레근 (좌)", "얼굴신경", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["이마근 (좌)", "얼굴신경", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["깨물근 (좌)", "삼차신경", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
            "summary": "Lt 특발성 얼굴신경마비 (Bell's Palsy)",
            "ncs_reason": [
    ...
    "양측 발바닥 저림 및 통증 (다발신경병증)": {
        "info": {"age": 68, "sex": "남성", "symptom": "양쪽 발바닥부터 무릎까지 화끈거리고 저린 증상이 대칭적으로 나타남", "side": "양측"},
        "ncs_sensory": [
            ["장딴지신경", "병변측(Rt)", "무반응", "측정불가", "비정상 (반응 소실)"],
            ["장딴지신경", "병변측(Lt)", "무반응", "측정불가", "비정상 (반응 소실)"],
            ["얕은종아리신경", "병변측(Rt)", "무반응", "측정불가", "비정상 (반응 소실)"],
            ["얕은종아리신경", "병변측(Lt)", "무반응", "측정불가", "비정상 (반응 소실)"],
            ["정중신경", "병변측(Rt)", "12 μV", "3.8 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정중신경", "병변측(Lt)", "13 μV", "3.7 ms", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["자신경", "병변측(Rt)", "14 μV", "3.1 ms", "비정상 (진폭 감소)"],
            ["자신경", "병변측(Lt)", "15 μV", "3.0 ms", "비정상 (진폭 감소)"],
        ],
        "ncs_motor": [
            ["정강신경", "발목", "병변측(Rt)", "1.8 mV", "6.2 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "발목", "병변측(Lt)", "1.7 mV", "6.4 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["정강신경", "오금", "병변측(Rt)", "1.5 mV", "15.8 ms", "38 m/s", "비정상 (전도속도 저하)"],
            ["정강신경", "오금", "병변측(Lt)", "1.4 mV", "16.1 ms", "37 m/s", "비정상 (전도속도 저하)"],
            ["종아리신경", "발목", "병변측(Rt)", "2.1 mV", "5.8 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "발목", "병변측(Lt)", "2.0 mV", "5.9 ms", "-", "비정상 (진폭 감소 / 잠복기 지연)"],
            ["종아리신경", "종아리뼈머리 아래", "병변측(Rt)", "1.8 mV", "14.5 ms", "39 m/s", "비정상 (전도속도 저하)"],
            ["종아리신경", "종아리뼈머리 아래", "병변측(Lt)", "1.7 mV", "14.8 ms", "38 m/s", "비정상 (전도속도 저하)"],
            ["정중신경", "손목", "병변측(Rt)", "6.5 mV", "4.1 ms", "-", "정상 범위"],
            ["정중신경", "손목", "병변측(Lt)", "6.8 mV", "4.0 ms", "-", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Rt)", "6.2 mV", "8.5 ms", "52 m/s", "정상 범위"],
            ["정중신경", "팔꿈치", "병변측(Lt)", "6.5 mV", "8.4 ms", "53 m/s", "정상 범위"],
        ],
        "emg": [
            ["앞정강근 (우)", "L4-L5", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["앞정강근 (좌)", "L4-L5", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["안쪽장딴지근 (우)", "S1-S2", "Fibrillation/PSW", "Reduced recruitment", "비정상 (활동성 탈신경)"],
            ["가쪽넓은근 (우)", "L3-L4", "Silent", "Normal recruitment", "정상 범위"],
            ["위팔두갈래근 (좌)", "C5-C6", "Silent", "Normal recruitment", "정상 범위"],
        ],
        "teaching_diagnosis": {
