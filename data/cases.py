...
CASE_LIBRARY = {
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "노쪽손목폄근(ECR)과 집게폄근(EIP)에서 휴식 시 섬유자발전위(Fibrillation potential) 및 양성예파(Positive sharp wave)의 탈신경 비정상 자발전위가 뚜렷하게 관찰됩니다. 이는 위팔뼈 나선고랑 통과 구간에서 발생한 기계적 압박에 기인한 원위부 축삭 단절 상태를 가리킵니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 앞정강근(TA)과 긴종아리근(PL)의 침근전도 소견 상 섬유자발전위(Fibrillation), 양성예파(Positive sharp wave)의 비정상 탈신경 자발 활동이 관찰됩니다. 석고 캐스트 장기 고정으로 비골두 가측 부위의 온종아리신경이 직접 압박을 받아 원위부 운동축삭 변성이 야기되었음을 가리킵니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "장딴지신경 감각신경활동전위, 넓적다리신경 및 종아리신경 복합근육활동전위 등 복수의 주요 말초 전도에서 진폭 감소가 확인됩니다. 이는 병변이 척수뒤뿌리신경절 원위부에 형성된 말초 신경얼기 줄기 장애임을 시사합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "장기 당뇨병 병력, 대칭성 원위부 장갑-양말 감각 저하, 아킬레스 반사 소실 및 다리 감각신경활동전위/복합근육활동전위 진폭 감소를 연결하여 최종 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
