...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "팔꿉관절 굽힘근: Fair (3/5)", "↳ 지배 신경: 근육피부신경(C5-C6)",
                    "손목관절 폄근: Fair (3/5)", "↳ 지배 신경: 노신경(C6-C7)",
                    "팔꿉관절 폄근: Normal (5/5)", "↳ 지배 신경: 노신경(C7-C8)"
                ],
    ...
    "야간 손저림과 엄지 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "엄지손가락 벌림근: Good (4/5)", "↳ 지배 신경: 정중신경(C8-T1)"
                ],
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "손목관절 폄근: Poor (2/5)", "↳ 지배 신경: 노신경(C6-C7)",
                    "손가락 폄근: Poor (2/5)", "↳ 지배 신경: 노신경(C7-C8)",
                    "팔꿉관절 폄근: Normal (5/5)", "↳ 지배 신경: 노신경(C7-C8)"
                ],
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "새끼손가락 벌림근: Fair (3/5)", "↳ 지배 신경: 자신경(C8-T1)",
                    "손가락 벌림/모음근: Fair (3/5)", "↳ 지배 신경: 자신경(C8-T1)"
                ],
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목관절 등굽힘근: Fair (3/5)", "↳ 지배 신경: 깊은종아리신경(L4-L5)",
                    "엄지발가락 폄근: Poor (2/5)", "↳ 지배 신경: 깊은종아리신경(L5)",
                    "엉덩관절 벌림근: Good (4/5)", "↳ 지배 신경: 위볼기신경(L4-S1)"
                ],
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목 등굽힘근: Poor (2/5)", "↳ 지배 신경: 깊은종아리신경(L4-L5)",
                    "발목 가쪽번짐근: Poor (2/5)", "↳ 지배 신경: 얕은종아리신경(L5-S1)",
                    "발목 안쪽번짐근: Normal (5/5)", "↳ 지배 신경: 정강신경(L4-L5)"
                ],
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "엉덩관절 굽힘근: Poor (2/5)", "↳ 지배 신경: 넙다리신경(L2-L4)",
                    "무릎관절 폄근: Poor (2/5)", "↳ 지배 신경: 넙다리신경(L2-L4)",
                    "발목 등굽힘근: Trace (1/5)", "↳ 지배 신경: 깊은종아리신경(L4-L5)"
                ],
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "양측 엄지발가락 폄근: Good (4/5)", "↳ 지배 신경: 깊은종아리신경(L5)",
                    "양측 엄지발가락 굽힘근: Good (4/5)", "↳ 지배 신경: 정강신경(S1-S2)"
                ],
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "양측 어깨 벌림근: Fair (3/5)", "↳ 지배 신경: 겨드랑신경(C5-C6)",
                    "양측 손목 폄근: Fair (3/5)", "↳ 지배 신경: 노신경(C6-C7)",
                    "양측 발목 등굽힘근: Fair (3/5)", "↳ 지배 신경: 깊은종아리신경(L4-L5)"
                ],
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "patient": {
            ...
            "physical_exam": {
                "얼굴 표정근 관찰": [
                    "이마 주름잡기, 눈 감기: 정상 (5/5)", "↳ 지배 신경: 얼굴신경(CN VII)"
                ],
