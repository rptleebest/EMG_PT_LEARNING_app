...
임상 표준 한글 신용어(영어) 규격을 엄격하게 반영했습니다.
"""
...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "감각신경활동전위(SNAP)가 정상 범위로 완전히 보존됩니다. 목 신경뿌리병증은 뒤뿌리신경절(Dorsal root ganglion, DRG)보다 몸쪽(Proximal)에 병변이 위치하므로, 축삭 손상이 먼쪽(Distal) 감각신경선까지 진행되지 않아 말초 감각신경전도검사 결과는 정상 범위로 도출되는 생리학적 특성을 지닙니다.",
                "운동신경전도검사의 복합근육활동전위(CMAP)가 정상 범위이므로 말초 신경얼기 혹은 단일 신경병증 가능성은 배제됩니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "목 척추주위근육(Cervical paraspinal), 위팔두갈래근(Biceps brachii), 노쪽손목폄근(Extensor carpi radialis)에서 휴식 시 섬유자발전위(Fibrillation potential) 및 양성예파(Positive sharp wave)의 비정상 자발활동전위가 관찰됩니다. 이는 C6 운동신경 축삭 손상으로 지배력을 유실한 먼쪽(Distal) 근섬유막 전체에 과흥분성 전기적 불안정성이 초래되었음을 뜻하는 활동성 탈신경(Active denervation) 지표입니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "최대 수의수축 시 위팔두갈래근과 노쪽손목폄근에서 감소된 운동단위동원(Reduced MU recruitment) 양상이 도출되어 동원 가능한 건강한 운동단위 수 자체가 크게 탈락했음을 증명합니다. 목 척추주위근육은 날카로운 통증으로 인해 수의수축 평가가 불가합니다.",
                "목 신경뿌리병증의 생리학적 감별 포인트:",
                "1) 감각 소실 영역이 C5 피부분절(위팔 가쪽)이 아닌 C6 피부분절(아래팔 노쪽 및 엄지손가락)에 명확히 일치합니다.",
                "2) 맨손근력검사(MMT) 상 C5 지배 어깨세모근(Deltoid)의 마비가 없고, C6 및 C7의 중첩 지배를 받는 노쪽손목폄근의 근력이 3/5(Fair)로 동반 위축되어 있습니다.",
            ...
            "integration": [
                "C6 피부분절 감각 저하, 위팔노근 반사 감소, 손목관절 폄 근력의 저하, 그리고 목 척추주위근육 및 먼쪽(Distal) 지배 근육의 동시 탈신경 자발활동 출현을 종합하여 최종 C6 목 신경뿌리병증(Cervical radiculopathy)으로 정의합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "말초 노신경병증이라면 표재노신경 감각신경활동전위(SNAP) 진폭 감소가 수반되며, 목 척추주위근육 침근전도검사는 완전히 정상 상태를 유지해야 합니다. 본 사례는 감각전도의 완전 보존과 목 척추주위근육의 이상 활동이 공존하여 목 신경뿌리병증으로 정의됩니다.",
                "practical_tip": "손목관절 폄 마비 환자 평가 시, 표재노신경 감각신경활동전위(SNAP)의 보존 여부와 목 척추주위근육(Cervical paraspinal)의 이상 방전 감별이 임상 판단의 핵심선입니다."
            }
        ]
    },
    ...
    "야간 손저림과 엄지 근력 약화": {
        ...
        "teaching_diagnosis": {
            "summary": "손목굴증후군(Carpal tunnel syndrome)을 시사하는 정중신경(Median nerve) 포착병증입니다.",
            "ncs_reason": [
                "정중신경 감각신경활동전위(SNAP)에서 잠복기 지연이 도출되어 손목굴 내 국소 말이집탈락(Demyelination)성 전도차단을 지시합니다.",
                "정중신경 복합근육활동전위(CMAP)에서 진폭 감소가 나타나 운동 축삭 손상(Axonal loss)이 함께 진행되고 있음을 뜻합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "짧은엄지벌림근(APB)에서 휴식 시 섬유자발전위나 양성예파 등의 이상 자발전위가 검출되지 않는 전기적 침묵(Silent at rest)의 정상 범위를 보입니다. 이는 정중신경 압박 포착 깊이가 경미하여 아직 먼쪽(Distal) 축삭 손상 단계까지는 유발되지 않았음을 뜻합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 짧은엄지벌림근(APB)의 수의수축 시 정상적인 운동단위동원(MU recruitment) 동원이 원활하게 일어납니다. 수축을 전달할 수 있는 하위 운동 축삭의 손실이 없어 간섭파형 형성이 온전히 보존되고 있음을 지시합니다."
            ],
            "integration": [
                "야간 통증 저림, 정중신경 분포 영역 감각 저하, 정중신경 전도 지연 및 짧은엄지벌림근(APB) 탈신경 전위 관찰을 종합하여 최종 정중신경 포착성 병변인 손목굴증후군(Carpal tunnel syndrome)으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "원엎침근(Pronator teres) 등 손목 상부의 몸쪽(Proximal) 정중신경 지배 근육들의 침근전도검사 결과가 정상이므로 손목 수준의 포착으로 확진할 수 있습니다.",
                "practical_tip": "포착 신경병증 감별 시, 포착 의심 경계선보다 더 몸쪽(Proximal)에서 기시하는 근육들의 정상 전기활동 보존 여부를 철저히 확인하십시오."
            }
        ]
    },
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "표재노신경 감각신경활동전위(SNAP) 진폭 감소는 병변이 뒤뿌리신경절보다 먼쪽(Distal)의 혼합 말초신경계 축삭 마비임을 가리킵니다.",
                "노신경 복합근육활동전위(CMAP) 진폭 저하 및 전도 지연은 나선고랑 하부 주행 경로 내 운동 축삭 손상을 대변합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "노쪽손목폄근(ECR)과 집게폄근(EIP)에서 휴식 시 섬유자발전위 및 양성예파의 탈신경 비정상 자발전위가 관찰됩니다. 이는 위팔뼈 나선고랑 통과 구간에서 발생한 기계적 압박에 기인한 먼쪽(Distal) 축삭 단절 상태를 가리킵니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 노쪽손목폄근(ECR)과 집게폄근(EIP)에서 감소된 운동단위동원(Reduced MU recruitment) 패턴 반응이 나타나 폄근 마비를 대변합니다. 반면 목 뒤가지 경로를 대변하는 목 척추주위근육(Cervical paraspinal)은 휴식 시 전기적 침묵, 수의수축 시 운동단위동원으로 정상을 보여 신경뿌리병증을 배제합니다."
            ],
            "integration": [
                "나선고랑 상단 골절력, 팔꿉관절 폄 기능 보존 대비 먼쪽(Distal) 손목/손가락 폄 근력의 저하, 표재노신경 SNAP의 진폭 감소, 목 척추주위근육 정상 전기활동을 융합하여 외상성 노신경병증(Radial neuropathy)으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "감각신경활동전위의 변성 탈락 유무가 노신경 주간 경로 마비와 먼쪽(Distal) 심부 운동 분지 마비를 감별하는 핵심 척도입니다."
            }
        ]
    },
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                "감각 검사": [
                    "반지손가락 자쪽 절반 및 새끼손가락 감각 저하. 자신경(Ulnar nerve) 피부분절 분포 영역에 국한됨"
                ],
                "맨손근력검사(MMT)": [
        ...
        "teaching_diagnosis": {
            "summary": "팔꿈치터널증후군(Cubital tunnel syndrome)으로 대표되는 팔꿈치 부위 자신경병증(Ulnar neuropathy)입니다.",
            "ncs_reason": [
                "자신경 감각신경활동전위(SNAP)에서 잠복기 지연이 관찰되어 팔꿈치 터널 구간 내의 국소 말이집탈락성 병변을 가리킵니다.",
                "자신경 복합근육활동전위(CMAP)의 진폭 저하는 포착성 신경 마비에 따르는 운동 축삭 손상 단계를 나타냅니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "새끼벌림근(ADM) 및 첫째등쪽뼈사이근(FDI)에서 휴식 시 섬유자발전위 및 양성예파의 탈신경 비정상 자발전위가 도출됩니다. 이는 주관 포착으로 인한 먼쪽 운동 축삭의 변성을 전기생리학적으로 지시합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 새끼벌림근 및 첫째등쪽뼈사이근에서 동원 가능한 총 결합 단위수 저하 현상에 기인한 감소된 운동단위동원 패턴 반응이 관찰됩니다."
            ],
            "integration": [
                "새끼손가락 감각 이상, 새끼벌림근 및 첫째등쪽뼈사이근 근력 저하, 자신경 잠복기 지연 및 침근전도검사 이상 소견을 융합하여 최종적으로 주관 포착인 팔꿈치터널증후군(Cubital tunnel syndrome)으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "얕은종아리신경 감각신경활동전위(SNAP)가 대칭성 정상 보존됩니다. 이는 감각 세포체가 위치한 뒤뿌리신경절보다 몸쪽인 요추 척수 내부 신경뿌리 압박 상황을 지지합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "허리 척추주위근육(Lumbar paraspinal), 앞정강근(TA), 긴엄지폄근(EHL), 중간볼기근(Gluteus medius)의 바늘 근전도 결과, 휴식 시 섬유자발전위 및 양성예파의 탈신경 자발전위가 대거 관찰됩니다. L5 척수 신경근의 물리적 압박으로 전근 운동 축삭의 퇴행이 진행 중임을 지시합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 앞정강근, 긴엄지폄근, 중간볼기근에서 동원 가능한 기능적 알파 운동신경원 수의 소실로 인해 감소된 운동단위동원 패턴이 관찰됩니다."
            ],
            "integration": [
                "L5 피부분절 감각 저하, 발처짐 및 중간볼기근 근력 저하, 감각신경활동전위 정상 보존 및 허리 척추주위근육 탈신경 전위 검출을 종합하여 L5 허리 신경뿌리병증(Lumbar radiculopathy)으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "발처짐 감별 시 엉덩관절 벌림 및 발목 안쪽번짐(Inversion) 근력의 보존 여부를 반드시 연계 확인하십시오."
            }
        ]
    },
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 앞정강근(TA)과 긴종아리근(PL)의 침근전도 소견 상 섬유자발전위, 양성예파의 비정상 탈신경 자발 활동이 관찰됩니다. 석고 캐스트 고정으로 온종아리신경이 직접 압박을 받아 먼쪽 운동축삭 변성이 야기되었음을 가리킵니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
            ...
            "integration": [
                "정강뼈 골절 부목 고정력, 정강신경 지배 발목 안쪽번짐 보존 및 종아리 지배 폄근 근력 저하, 감각신경활동전위 감소를 종합하여 최종적으로 압박성 온종아리신경 마비로 정의합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "뒤정강근(Tibialis posterior)이 분담하는 안쪽번짐 기능 보존 여부가 L5 뿌리 마비와 말초 온종아리신경 마비를 가르는 임상적 열쇠입니다."
            }
        ]
    },
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "장딴지신경 감각신경활동전위(SNAP), 넓적다리신경 및 종아리신경 복합근육활동전위(CMAP) 등 복수의 주요 말초 전도에서 진폭 감소가 확인됩니다. 이는 병변이 척수뒤뿌리신경절 먼쪽에 형성된 말초 신경얼기 줄기 장애임을 시사합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 가쪽넓은근(Vastus lateralis)과 앞정강근(TA) 침근전도 검사에서, 휴식 시 섬유자발전위 및 양성예파의 탈신경 자발 활동전위가 관찰되어, 골반 외상에 수반된 운동축삭 손상 상황을 대변합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 가쪽넓은근과 앞정강근에서 감소된 운동단위동원 패턴 현상이 도출됩니다. 반면 허리 척추주위근은 휴식 시 전기적 침묵, 수의수축 시 운동단위동원으로 정상을 보여 다발 신경뿌리가 아닌 신경얼기(Plexus) 수준의 파열 손상임을 밝힙니다."
            ],
            "integration": [
                "골반 골절 외상 및 고정 수술력, 다리 다발 신경 영역의 동시 근력 저하, 다발성 감각신경활동전위/복합근육활동전위 감소, 척추주위근 보존을 종합하여 최종 허리엉치신경얼기 마비로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "양측 앞정강근(TA)의 침근전도 결과, 휴식 시 섬유자발전위 및 양성예파의 탈신경 비정상 자발전위가 좌우 대칭 분포로 유도됩니다. 대사성 축삭 병변으로 인해 긴 말단 축삭 가지부터 대칭 손상해 들어오는 dying-back 기전의 세포학적 단서입니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 앞정강근 근육들의 수의수축 시, 운동단위 소실 및 잔여 축삭 발아에 기초하여 거대운동단위활동전위 출현 및 감소된 운동단위동원 양상이 좌우 대칭적으로 발생하여 만성 축삭 파괴 상태를 지지합니다."
            ],
            "integration": [
                "장기 당뇨병 병력, 대칭성 먼쪽 장갑-양말 감각 저하, 아킬레스 반사 소실 및 다리 감각신경활동전위/복합근육활동전위 진폭 감소를 연결하여 최종 길이 의존성 축삭성 다발신경병증으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "양측 앞정강근(TA)의 침근전도 결과, 휴식 시 자발 활동이 전혀 관찰되지 않는 전기적 침묵이 나타나 정상 소견을 보입니다. 축삭 손상이 동반되지 않은 탈말이집 상태임을 생리학적으로 입증합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 앞정강근(TA) 근육의 수의수축 시 정상적인 운동단위동원 양상이 나타납니다. 축삭 단절에 의한 지배 유실이 없으므로 수의수축 시 간섭파형 동원은 완벽히 유발 보존되고 있음을 지시합니다."
            ],
            "integration": [
                "근위/먼쪽 동시 마비, 전신 무반사, 다발성 잠복기 지연 및 F파 지연 소실을 종합하여 최종 만성 염증성 말이집탈락성 다발신경병증으로 판단합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            "summary": "우측 삼차신경의 들신경 경로(Afferent limb) 손상입니다.",
            "ncs_reason": [
            ...
            "integration": [
                "우측 삼차신경 지배 가지의 촉각 저하, 우측 각막반사 감소 및 우측 자극 시 양측 수축 반응의 전기적 지연 소실을 종합하여 최종 우측 삼차신경 전도 장애(Afferent trunk dysfunction)로 판독합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "우측 얼굴신경 병변(Efferent pathway)이라면 좌측 자극 시에도 우측 반응인 우측 R2가 소실되며, 본 환자는 좌측 자극 시 우측 R2가 정상입니다.",
                "practical_tip": "눈깜빡반사(Blink reflex) 판독 시 전기 자극을 준 쪽이 문제인지(들신경/Trigeminal), 반응을 하는 눈꺼풀 근육 쪽이 문제인지(날신경/Facial) 구분하세요."
            }
        ]
    },
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "MAS 3등급의 보행 불능 환자에게 물리치료를 적용한 후, H-반사의 진폭 감소 및 H/M 비율의 정량적 회복을 통해 위운동신경세포 증후군(UMN syndrome) 환자의 소폭 경직 완화 효과를 검증한 임상 사례입니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "말이집탈락성 S1 신경뿌리병증",
