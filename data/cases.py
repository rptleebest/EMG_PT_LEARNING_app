...
CASE_LIBRARY = {
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "반사궁 회로 전도 결손만을 평가하는 검사이므로, 환자 보호를 위해 침근전도는 배제되었습니다."
            ],
            "integration": ["우측 V1 가지 촉각 저하 및 우측 자극 시에만 나타나는 양측 반사 지연을 종합하여 삼차신경 들신경로(afferent) 장애로 판독합니다."],
        },
        "differential_diagnosis": [
            {
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "findings": {
            ...
            "우측 가자미근 H-반사 진폭 (물리치료 후)": ("5.7 mV", "정상 범위: 0.5~5.0 mV", H_REFLEX_HYPERACTIVE),
            "우측 가자미근 H/M ratio (물리치료 전)": ("65%", "정상 기준치 < 40%", H_M_RATIO_INCREASED),
            "우측 가자미근 H/M ratio (물리치료 후)": ("55%", "정상 기준치 < 40%", H_M_RATIO_INCREASED),
        },
        "teaching_diagnosis": {
