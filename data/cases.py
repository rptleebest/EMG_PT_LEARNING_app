...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "팔꿉관절 굽힘근: Fair (3/5) | 근육피부신경(C5-6)",
                    "손목관절 폄근: Fair (3/5) | 노신경(C6-7)",
                    "팔꿉관절 폄근: Normal (5/5) | 노신경(C7-8)"
                ],
                "반사 검사": ["위팔노근 반사(C6): 감소 (DTR 1+)", "위팔두갈래근 반사(C5): 정상 (DTR 2+)"],
            },
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "가장 몸쪽 가까운 부위(proximal)인 C6 척추주위근의 이상 소견은 병변이 척수 신경뿌리임을 나타내는 핵심 지표입니다."
            ],
        ...
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "손목관절 폄 마비 환자 평가 시, 표재노신경 감각전도의 보존 여부와 목 척추주위근의 이상 활동전위 감별이 임상 판단의 핵심입니다."
            }
        ],
    },
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "손목관절 폄근: Poor (2/5) | 노신경(C6-7)",
                    "손가락 폄근: Poor (2/5) | 노신경(C7-8)",
                    "팔꿉관절 폄근: Normal (5/5) | 노신경(C7-8)"
                ],
                "반사 검사": ["위팔세갈래근 반사(C7): 정상 (DTR 2+)", "위팔노근 반사(C6): 감소 (DTR 1+)"],
            },
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "목 척추주위근은 온전히 보존되어 있어 목 신경뿌리병증을 배제합니다."
            ],
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "새끼손가락 벌림근: Fair (3/5) | 자신경(C8-T1)",
                    "손가락 벌림/모음근: Fair (3/5) | 자신경(C8-T1)"
                ],
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목관절 등굽힘근: Fair (3/5) | 깊은종아리신경(L4-5)",
                    "엄지발가락 폄근: Poor (2/5) | 깊은종아리신경(L5)",
                    "엉덩관절 벌림근: Good (4/5) | 위볼기신경(L4-S1)"
                ],
                "반사 검사": ["무릎반사(L4): 정상 (DTR 2+)", "아킬레스힘줄반사(S1): 정상 (DTR 2+)"],
            },
        },
        "findings": {
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목 등굽힘근: Poor (2/5) | 깊은종아리신경(L4-5)",
                    "발목 가쪽번짐근: Poor (2/5) | 얕은종아리신경(L5-S1)",
                    "발목 안쪽번짐근: Normal (5/5) | 정강신경(L4-5)"
                ],
                "반사 검사": ["무릎반사(L4) 및 아킬레스힘줄반사(S1): 대칭적 정상 (DTR 2+)"],
            },
        },
        "findings": {
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "엉덩관절 굽힘근: Poor (2/5) | 넙다리신경(L2-4)",
                    "무릎관절 폄근: Poor (2/5) | 넙다리신경(L2-4)",
                    "발목 등굽힘근: Trace (1/5) | 깊은종아리신경(L4-5)"
                ],
                "반사 검사": ["무릎반사(L4) 및 아킬레스힘줄반사(S1): 좌측 소실 (DTR 0)"],
            },
        },
        "findings": {
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "양측 엄지발가락 폄근: Good (4/5) | 깊은종아리신경(L5)",
                    "양측 엄지발가락 굽힘근: Good (4/5) | 정강신경(S1-2)"
                ],
                "반사 검사": ["양측 아킬레스힘줄반사(S1): 소실 (DTR 0)", "양측 무릎반사(L4): 정상 (DTR 2+)"],
            },
        },
        "findings": {
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "양측 어깨 벌림근: Fair (3/5) | 겨드랑신경(C5-6)",
                    "양측 손목 폄근: Fair (3/5) | 노신경(C6-7)",
                    "양측 발목 등굽힘근: Fair (3/5) | 깊은종아리신경(L4-5)"
                ],
                "반사 검사": ["전신 깊은힘줄반사(DTR): 소실 (DTR 0)"],
            },
        },
        "findings": {
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "patient": {
            ...
            "physical_exam": {
                "얼굴 표정근 관찰": [
                    "이마 주름잡기, 눈 감기: 정상 (5/5) | 얼굴신경(CN VII)"
                ],
                "뇌신경 감각 검사": ["우측 이마 및 눈 주변(삼차신경 V1) 촉각 감소"],
                "반사 검사": ["우측 각막반사(CN V, VII): 저하 관찰"],
            },
        },
        "findings": {
            "우측 전기자극-우측 R1 반응 ": ("잠복기 지연", "14.8 ms", BLINK_DELAYED),
            "우측 전기자극-우측 R2 반응 ": ("반응 소실", "측정불가", BLINK_DELAYED_ABSENT),
            "우측 전기자극-좌측 R2 반응 ": ("반응 소실", "측정불가", BLINK_DELAYED_ABSENT),
            "좌측 전기자극-좌측 R1 반응 ": ("정상 유발", "10.4 ms", NCS_NORMAL),
            "좌측 전기자극-좌측 R2 반응 ": ("정상 유발", "32.1 ms", NCS_NORMAL),
            "좌측 전기자극-우측 R2 반응 ": ("정상 유발", "31.8 ms", NCS_NORMAL),
        },
        "teaching_diagnosis": {
            "summary": "우측 삼차신경(Trigeminal nerve) 들신경 경로(Afferent limb) 손상입니다.",
            "ncs_reason": [
                "우측 전기자극 시 우측 R1 (동측 단일시냅스), 우측 R2 (동측 다시냅스), 좌측 R2 (반대측 다시냅스) 반사 반응이 모두 반사 유발 소실되거나 지연됩니다.",
                "좌측 전기자극 시 우측 R2 (반대측 다시냅스) 반사 반응까지 정상 도출되어 운동을 지시하는 얼굴신경은 보존됨을 확증합니다."
            ],
            "integration": [
                "우측 전기자극 시 우측 R1 (동측 단일시냅스), 우측 R2 (동측 다시냅스), 좌측 R2 (반대측 다시냅스) 반사 반응이 모두 반사 유발 소실되거나 지연됩니다.",
                "좌측 전기자극 시 우측 R2 (반대측 다시냅스) 반사 반응까지 정상 도출되어 운동을 지시하는 얼굴신경은 보존됨을 확증합니다.",
                "우측 삼차신경 얼굴가지(V1) 가지 촉각 저하 및 우측 자극 시에만 나타나는 양측 반사 지연을 종합하여 삼차신경 들신경로(afferent) 장애로 판독합니다.",
            ],
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "우측 얼굴신경(운동) 마비라면 좌측 전기자극 시 우측 눈 감기 반응(우측 R2)이 소실되어야 합니다.",
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "patient": {
            ...
            "symptoms": ["뇌졸중 편마비 상태, 우측 발목 발바닥굽힘근 중증 경직", "보행 제한으로 물리치료 전/후 경직 완화 효과 정량적인 모니터링"],
            "physical_exam": {
                "근긴장도 검사(MAS)": ["우측 MAS: 3등급"],
                "반사 검사": [
                    "아킬레스힘줄반사(S1): 우측 비정상적 항진 (DTR 3+ 이상)", 
                    "발목간대경련(Ankle clonus): 관찰됨"
                ],
            },
        },
        "findings": {
            "우측 가자미근 H-반사 진폭 (물리치료 전)": ("7.2 mV", "정상 범위: 0.5~5.0 mV", "경직도 높음 (과항진)"),
            "우측 가자미근 H-반사 진폭 (물리치료 후)": ("5.7 mV", "정상 범위: 0.5~5.0 mV", "경직 소폭 감소"),
            "우측 가자미근 H/M ratio (물리치료 전)": ("65%", "정상 기준치 < 40%", "경직도 높음 (비율 증가)"),
            "우측 가자미근 H/M ratio (물리치료 후)": ("55%", "정상 기준치 < 40%", "경직 소폭 감소"),
        },
        "teaching_diagnosis": {
            ...
            "integration": [
                "MAS 3등급의 보행 제한 환자에게 물리치료를 적용한 후, H-반사의 진폭 감소 및 H/M 비율의 감소(65%에서 55%)를 통해 소폭의 경직 완화를 정량적으로 확인합니다."
            ]
        },
    },
}
