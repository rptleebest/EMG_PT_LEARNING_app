...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "감각신경활동전위(SNAP)가 대칭적으로 정상 범위로 완전히 보존됩니다. 이는 감각 세포체가 있는 뒤뿌리신경절(DRG)보다 몸쪽(proximal) 척수 신경뿌리에서 발생한 병변임을 시사하는 핵심 지표입니다."
            ],
            "motor_reason": [
                "말초 운동신경전도(CMAP)에서 전도속도 저하나 전도차단 소견이 발견되지 않아, 팔꿈치나 손목 등 말초 부위에서의 포착성 신경병증 가능성을 배제할 수 있습니다."
            ],
            "emg_reason": [
                "1) 휴식 시 비정상 자발활동: 목 척추주위근을 포함하여 C6 척수 분절을 공유하는 위팔두갈래근과 노쪽손목폄근에서 활동성 탈신경 전위가 동시 관찰됩니다.",
                "2) 자발적 근수축 시 운동단위 동원: 최대 수축 시 관련 근육들에서 운동단위 동원이 대폭 감소하여 실제 운동 축삭의 손실이 확인됩니다."
            ],
            "integration": [
                "🎯 C6 목 신경뿌리병증 (C6 Cervical Radiculopathy)",
                "💡 추정한 이유: 임상적으로 C6 피부분절 감각 저하와 위팔노근 반사 감소가 명확하며, 감각신경전도는 보존되나 침근전도에서 목 척추주위근을 포함한 C6 지배 근육들에 다발성 탈신경이 확인되어 척수 신경뿌리 압박으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ 노신경병증 (Radial neuropathy)",
                "how_to_differentiate": "말초 노신경 마비라면 표재노신경 감각 전도(SNAP) 진폭이 반드시 감소해야 하며, 목 척추주위근은 완전히 정상이어야 합니다."
            }
        ]
    },
    ...
    "야간 손저림과 엄지 근력 약화": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "정중신경 감각신경(SNAP)에서만 선택적으로 잠복기 지연이 도출되어, 손목굴 내 국소 말이집탈락성 전도차단이 발생했음을 보여줍니다. 인접한 자신경은 정상입니다."
            ],
            "motor_reason": [
                "운동신경전도(CMAP) 시 손목 자극에서 진폭 감소가 나타나, 단순 말이집 손상을 넘어 일부 운동 축삭의 변성이 동반되고 있음을 뜻합니다."
            ],
            "emg_reason": [
                "짧은엄지벌림근에서 비정상 자발전위가 검출되지 않고 자발적 근수축 동원 양상이 양호합니다. 이는 압박이 아직 근섬유의 광범위한 탈신경을 유발할 정도의 말기 단계는 아님을 의미합니다."
            ],
            "integration": [
                "🎯 오른쪽 손목굴증후군 (Carpal tunnel syndrome)",
                "💡 추정한 이유: 야간 통증 및 손털기 증상과 정중신경 영역에 국한된 임상 징후가 명확하며, 검사 결과 정중신경 먼쪽(distal) 구간의 전도 지연 및 진폭 감소가 확인되어 손목 부위 정중신경 포착으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ 몸쪽 정중신경병증 (원엎침근 증후군)",
                "how_to_differentiate": "원엎침근 등 팔꿈치 아래 몸쪽 정중신경 지배 근육들의 침근전도가 정상이며, 전도 지연이 '손목' 구간에서만 뚜렷하므로 구분됩니다."
            }
        ]
    },
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "patient": {
            ...
            "symptoms": [
                "교통사고로 인한 오른쪽 위팔뼈 몸통 나선형 골절로 금속판 고정 수술을 시행 받음.",
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "표재노신경 감각신경(SNAP)의 진폭 감소는 병변이 척수 신경절(DRG)보다 먼쪽(distal)에 위치한 말초 노신경 축삭 손상임을 강력히 시사합니다."
            ],
            "motor_reason": [
                "노신경 운동검사(CMAP)에서 진폭 감소가 확인되어, 위팔뼈 골절 부위에서 운동 축삭의 파괴가 동반된 중등도 이상의 손상임을 입증합니다."
            ],
            "emg_reason": [
                "노쪽손목폄근과 집게폄근에서 활동성 탈신경 자발전위가 뚜렷하게 관찰됩니다. 목 척추주위근은 정상으로 유지되어 경추부 질환을 배제합니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                "name": "⚖️ 뒤뼈사이신경병증 (PIN)",
                "how_to_differentiate": "PIN은 순수 운동 분지 손상이므로 표재노신경 피부 감각 소실이 없어야 합니다. 본 사례는 감각 진폭 감소가 뚜렷하므로 나선고랑 부위 마비로 감별됩니다."
            }
        ]
    },
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "motor_reason": [
                "운동신경전도(CMAP)에서 팔꿈치 아래와 비교해 '팔꿈치 위' 자극 시 진폭이 급감하는 국소 전도차단이 명확히 관찰되어, 팔꿈치 터널에서의 압박 마비를 입증합니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                ...
                "💡 추정한 이유: 4, 5지 감각 이상과 손 내재근 약화, 팔꿈치 구간에서의 자신경 전도차단 및 해당 근육의 침근전도 이상을 종합하여 팔꿈치 주관 포착으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ C8-T1 목 신경뿌리병증",
                "how_to_differentiate": "신경뿌리병증은 자신경 지배 영역 외에 정중신경 근육도 동시 침범하며, 말초 감각신경 전도(SNAP)는 정상으로 보존되어야 합니다."
            }
        ]
    },
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "얕은종아리신경과 장딴지신경의 감각신경 전도(SNAP)가 정상으로 완전히 보존됩니다. 이는 감각 세포체가 위치한 뒤뿌리신경절(DRG)보다 몸쪽인 척수 신경뿌리 압박임을 강력히 지지합니다."
            ],
            "motor_reason": [
                "말초 운동신경전도(CMAP)에서 전도차단이나 지연 소견이 발견되지 않아 무릎 주변에서의 말초 신경 압박 가능성을 배제합니다."
            ],
            "emg_reason": [
                "허리 척추주위근, 앞정강근, 중간볼기근에서 탈신경 자발전위가 대거 관찰됩니다. 서로 다른 말초신경 지배를 받으나 L5 분절을 공유하는 근육들의 동시 탈신경입니다."
            ],
            "integration": [
                "🎯 L5 허리 신경뿌리병증 (L5 Lumbar radiculopathy)",
                "💡 추정한 이유: 말초 감각/운동 전도가 정상 보존되고, 침근전도에서 L5 지배 다발 근육 및 핵심적인 요추 척추주위근 침범이 확인되어 척수 신경뿌리 압박으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ 온종아리신경병증 (Common peroneal neuropathy)",
                "how_to_differentiate": "온종아리 마비는 얕은종아리신경 감각 전도 진폭이 대폭 감소하며, 위볼기신경이 지배하는 중간볼기근과 허리 척추주위근은 완벽히 정상으로 유지됩니다."
            }
        ]
    },
    ...
    "온종아리신경 외상성 손상 의심": {
        ...
        "teaching_diagnosis": {
            ...
            "motor_reason": [
                "종아리뼈머리 부위 자극 시 운동신경(CMAP) 진폭이 크게 떨어지는 것은 타격 부위에서의 직접적인 전도차단과 축삭 손상을 뒷받침합니다."
            ],
            "emg_reason": [
                "종아리신경 분지가 지배하는 앞정강근 등에서 활동성 탈신경 전위가 뚜렷합니다. 허리 척추주위근은 조용하여 신경뿌리 병변을 배제합니다."
            ],
            "integration": [
                "🎯 온종아리신경병증 (Common peroneal neuropathy)",
                "💡 추정한 이유: 무릎 바깥쪽 타박상 이력, 정강신경 지배 근육의 보존, 그리고 감각신경 전도 저하와 운동 전도차단을 종합하여 외상성 단일 말초신경 마비로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ L5 허리 신경뿌리병증",
                "how_to_differentiate": "신경뿌리 마비 시 감각 전도(SNAP)는 정상 수준으로 유지되며, 허리 척추주위근 및 중간볼기근 침범이 뚜렷하게 도출됩니다."
            }
        ]
    },
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "다수의 다리 말초 감각신경(SNAP)에서 광범위한 진폭 감소가 일제히 확인되어 척수신경절 바깥 영역인 '신경얼기(Plexus)'의 중대한 손상을 시사합니다."
            ],
            "motor_reason": [
            ...
            "integration": [
                ...
                "💡 추정한 이유: 골반 외상 이력, 다리에 분포하는 여러 신경 네트워크의 동시 마비, 다발 감각신경 진폭 감소 및 척추주위근 보존 패턴을 결합하여 복합 신경얼기 손상으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "다리 먼쪽(distal) 감각신경들에서 대칭적인 진폭 감소가 두드러집니다. 이는 길이가 긴 신경 축삭 말단부터 손상되는 Dying-back 양상과 부합합니다."
            ],
            "motor_reason": [
                "운동신경(CMAP)의 진폭 또한 대칭적으로 감소하여 만성적인 전신 축삭성 변성 상태임을 보여줍니다."
            ],
            "emg_reason": [
                "양측 앞정강근에서 만성적인 탈신경 자발전위와 자발적 근수축 시 운동단위 동원 감소가 대칭 분포로 나타납니다."
            ],
            "integration": [
                "🎯 길이 의존성 축삭성 다발신경병증 (Length-dependent axonal polyneuropathy)",
                "💡 추정한 이유: 만성 당뇨 병력, 대칭적 장갑-양말형 감각 저하, 먼쪽 깊은힘줄반사 소실 및 대칭성 진폭 감소 수치를 연결하여 전신적 축삭 손상으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "상부 위팔신경얼기병증 의심": {
        ...
        "teaching_diagnosis": {
            "sensory_reason": [
                "가쪽아래팔피부신경 감각 진폭(SNAP)이 비정상으로 저하되어, 병변이 뒤뿌리신경절(DRG)보다 바깥쪽인 위팔신경얼기 수준에 있음을 증명합니다."
            ],
            "motor_reason": [
                "겨드랑신경과 근육피부신경의 운동 반응(CMAP)이 대폭 소실되어 상부 줄기(Upper trunk)의 심각한 축삭 손상이 확인됩니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                ...
                "💡 추정한 이유: 감각 전도의 뚜렷한 감소, C5-C6 분지를 아우르는 복합 근육 마비, 그러나 목 척추주위근은 완전히 정상인 패턴을 종합해 신경얼기 손상으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ C5-C6 신경뿌리병증",
                "how_to_differentiate": "신경뿌리 마비 시 말초 감각신경전도(SNAP)는 보존되고 목 척추주위근에 탈신경 이상이 명확하게 관찰되어야 합니다."
            }
        ]
    },
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "teaching_diagnosis": {
            ...
            "motor_reason": [
                "운동신경(CMAP) 잠복기 지연 및 F파 소실은 신경뿌리를 포함한 몸쪽 부위까지 다발성 전도 지연이 발생했음을 가리킵니다."
            ],
            "emg_reason": [
                "침근전도에서 축삭 손상을 대변하는 비정상 자발전위가 발견되지 않아, 현재는 주로 말이집 손상 상태임을 지시합니다."
            ],
            "integration": [
                "🎯 만성 염증성 말이집탈락성 다발신경병증 (CIDP)",
                "💡 추정한 이유: 전신 대칭 마비와 무반사, 다발적인 전도 잠복기 지연 및 F파 소실을 통해 염증성 말이집 탈락 질환으로 판단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ 근육병증(Myopathy)",
                "how_to_differentiate": "근육병증은 말단 감각 소실이 없으며 전신 깊은힘줄반사도가 어느 정도 보존됩니다."
            }
        ]
    },
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            "reflex_reason": [
                "오른쪽을 자극할 때 연관된 3가지 반사 반응(Rt R1, Rt R2, Lt R2)이 모두 지연되거나 소실되었습니다. 반면 왼쪽 자극 시에는 동측 반응뿐 아니라 건너편 오른쪽 눈을 감는 반응(Rt R2)도 정상입니다.",
                "이는 반응을 수행하는 날신경(얼굴신경)은 정상이지만, 자극을 감지해 보내는 들신경(삼차신경) 오른쪽 경로가 손상되었음을 확증합니다."
            ],
            "integration": [
                "🎯 우측 삼차신경 전도 장애 (Trigeminal afferent pathway dysfunction)",
                "💡 추정한 이유: 얼굴 표정근의 정상 기능, 우측 이마 감각 저하, 그리고 눈깜빡반사에서 우측 자극 시에만 전체 반응이 차단되는 현상을 결합하여 감각 수용체 경로 마비로 판독합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "⚖️ 오른쪽 말초성 얼굴마비 (Bell's palsy)",
                "how_to_differentiate": "얼굴마비라면 왼쪽을 자극했을 때도 오른쪽 눈을 감는 반응(Rt R2)이 소실되어야 하나, 본 환자는 왼쪽 자극 시 오른쪽 반응을 원활히 수행합니다."
            }
        ]
    },
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "patient": {
            ...
            "symptoms": [
                ...
                "최근 좌측 발목 장딴지 근육의 뻣뻣한 강직이 심해져 보행 시 첨족(toe walking) 양상이 심해 물리치료실에서 중재 전/후 효과를 정량 평가하고자 내원함."
            ],
            "physical_exam": {
                "근긴장도 검사": [
        ...
        "teaching_diagnosis": {
            "reflex_reason": [
                "H-반사는 척수 단일 시냅스 반사회로의 흥분성을 평가합니다. 물리치료 적용 전 편마비측 H/M 비율이 65%로 폭발적으로 항진된 것은 대뇌 억제 상실로 인한 과흥분 상태(경직)를 입증합니다.",
                "치료 후 비율이 55%로 감소한 것은 치료 중재에 의해 척수 반사 흥분성이 일부 완화되었음을 정량적으로 보여줍니다."
            ],
            "integration": [
                "🎯 위운동신경세포 증후군에 의한 왼쪽 하지 경직 정량평가",
                "💡 평가 요약: 뇌졸중 환자에서 관찰되는 비정상적 H-반사 항진(H/M 비율 증가)은 중추성 억제 상실 상태임을 확증하며, 치료 전후 비율 변화를 통해 물리치료 중재의 성과 지표로 활용할 수 있습니다."
            ]
        },
        "differential_diagnosis": []
    }
