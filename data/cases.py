...
- 신용어 표준 적용: 목(Cervical), 허리(Lumbar), 얼굴(Facial), 가슴문증후군(Thoracic outlet syndrome), 몸쪽(Proximal), 먼쪽(Distal) 등 일치화
- 결과 해석 부분은 항상 '신용어 한글(영어)' 구조로 반복 명시하여 학생 학습 효과 극대화
- 맨손근력검사(MMT) 정보에서 가독성을 방해하는 구체적 근육명 완전 삭제 조치 완료
- 파일 하단 딕셔너리 차단 중괄호(}) 무결성 검증 완료
"""
...
CASE_LIBRARY = {
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "운동신경전도검사(Motor NCS)의 복합근육활동전위(CMAP)가 정상 범위이므로 말초 신경얼기(Plexus) 혹은 단일 신경병증 가능성은 배제됩니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                ...
                "2) 수의수축 시 운동단위 동원 분석:",
                "최대 수의수축 시 위팔두갈래근과 노쪽손목폄근에서 감소된 운동단위동원(Reduced MU recruitment) 양상이 도출되어 동원 가능한 건강한 운동단위(Motor Unit, MU) 수 자체가 크게 탈락했음을 증명합니다. 목 척추주위근육(Paraspinal muscle)은 날카로운 통증으로 인해 수의수축 평가가 불가합니다.",
                "목 신경뿌리병증(Cervical radiculopathy)의 생리학적 감별 포인트:",
                "1) 감각 소실 영역이 C5 피부분절(위팔 가쪽)이 아닌 C6 피부분절(아래팔 노쪽 및 엄지손가락)에 명확히 일치합니다.",
                "2) 맨손근력검사(MMT) 상 C5 지배 어깨세모근의 마비가 없고, C6 및 C7의 중첩 지배를 받는 노쪽손목폄근의 근력이 3/5(Fair)로 동반 위축되어 있습니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "말초 노신경병증(Radial neuropathy)이라면 표재노신경 감각신경활동전위(SNAP) 진폭 감소(정상측 대비 50% 이하)가 수반되며, 목 척추주위근육(Paraspinal muscle) 침근전도검사(Needle EMG)는 완전히 정상 상태를 유지해야 합니다. 본 사례는 감각전도의 완전 보존과 목 척추주위근육(Paraspinal muscle)의 이상 활동이 공존하여 목 신경뿌리병증(Cervical radiculopathy)으로 정의됩니다.",
    ...
    "야간 손저림과 엄지 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "정중신경(Median nerve) 감각신경활동전위(SNAP)에서 잠복기 지연(정상측 대비 130% 이상)이 도출되어 손목굴 내 국소 말이집탈락(Demyelination)성 전도차단을 지시합니다.",
            ...
            "emg_reason": [
                ...
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 짧은엄지벌림근의 수의수축 시 정상적인 운동단위동원(MU recruitment) 동원이 원활하게 일어납니다. 수축을 전달할 수 있는 하위 운동 축삭의 손실이 없어 간섭파형 형성이 온전히 보존되고 있음을 지시합니다."
            ],
            "integration": [
                "야간 통증 저림, 정중신경(Median nerve) 분포 영역 감각 저하, 정중신경 전도 지연 및 짧은엄지벌림근(APB) 탈신경 전위 관찰을 종합하여 최종 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "원엎침근(Pronator teres) 등 손목 상부의 몸쪽(Proximal) 정중신경(Median nerve) 지배 근육들의 침근전도검사(Needle EMG) 결과가 정상이므로 손목 수준의 포착으로 확진할 수 있습니다.",
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "노신경(Radial nerve) 복합근육활동전위(CMAP) 진폭 저하(정상측 대비 50% 이하) 및 전도 지연은 나선고랑 하부 주행 경로 내 운동 축삭 손상(Axonal loss)을 대변합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
            ...
            "integration": [
                "나선고랑 상단 골절력, 팔꿉관절 폄 기능 보존 대비 먼쪽(Distal) 손목/손가락 폄 근력의 저하, 표재노신경(Superficial radial nerve) SNAP의 진폭 감소(50% 이하), 목 척추주위근육(Paraspinal muscle) 정상 전기활동을 융합하여 외상성 노신경병증(Radial neuropathy)으로 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "뒤뼈사이신경(Posterior interosseous nerve)은 노신경(Radial nerve)의 순수 운동 분지이므로 감각 소실 영역이 없어야 하며, 표재노신경 감각신경활동전위(SNAP)가 완전 정상 범위로 기록되어야만 합니다.",
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "자신경(Ulnar nerve) 감각신경활동전위(SNAP)에서 잠복기 지연(정상측 대비 130% 이상)이 관찰되어 팔꿈치 터널 구간 내의 국소 말이집탈락(Demyelination)성 병변을 가리킵니다.",
                "자신경(Ulnar nerve) 복합근육활동전위(CMAP)의 진폭 저하(정상측 대비 50% 이하)는 포착성 신경 마비에 따르는 운동 축삭 손상(Axonal loss) 단계를 고발합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "새끼벌림근 및 첫째등쪽뼈사이근에서 휴식 시 섬유자발전위(Fibrillation potential) 및 양성예파(Positive sharp wave)의 탈신경 비정상 자발전위가 도출됩니다. 이는 주관 포착으로 인한 먼쪽(Distal) 운동 축삭의 변성을 전기생리학적으로 지시합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 새끼벌림근 및 첫째등쪽뼈사이근에서 동원 가능한 총 결합 단위수 저하 현상에 기인한 감소된 운동단위동원(Reduced MU recruitment) 패턴 반응이 정밀 관찰됩니다."
            ],
            "integration": [
                "새끼손가락 감각 이상, 새끼벌림근 및 첫째등쪽뼈사이근 근력 저하, 자신경(Ulnar nerve) 잠복기 지연 및 침근전도검사(Needle EMG) 이상 소견을 융합하여 팔꿈치터널증후군(Cubital tunnel syndrome)으로 진단합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "C8-T1 목 신경뿌리병증(Cervical radiculopathy)",
                "why_consider": "손 내재근 약화 분절이 C8-T1 영역과 일치하여자경 신경 분포와 흡사하게 관찰될 수 있습니다.",
                "how_to_differentiate": "목 신경뿌리병증(Cervical radiculopathy)은 정중신경 지배 손가락 근육들도 전반적으로 동시 침범되며, 표재 자신경 감각신경활동전위(SNAP)는 정상 범위로 완벽 보존되는 특징이 있습니다.",
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "얕은종아리신경(Superficial peroneal nerve) 감각신경활동전위(SNAP)가 대칭성 정상 보존됩니다. 이는 감각 세포체가 위치한 뒤뿌리신경절(Dorsal root ganglion, DRG)보다 몸쪽(Proximal)인 요추 척수 내부 신경뿌리 압박 상황을 지지합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "허리 척추주위근육(Paraspinal muscle), 앞정강근(TA), 긴엄지폄근(EHL), 중간볼기근의 바늘 근전도 결과, 휴식 시 섬유자발전위(Fibrillation potential) 및 양성예파(Positive sharp wave)의 탈신경 자발전위가 대거 관찰됩니다. L5 척수 신경근의 물리적 압박으로 전근 운동 축삭의 퇴행이 진행 중임을 전기생리학적으로 지시합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 앞정강근, 긴엄지폄근, 중간볼기근에서 동원 가능한 기능적 알파 운동신경원 수의 유의미한 소실로 인해 감소된 운동단위동원(Reduced MU recruitment) 패턴이 뚜렷하게 관찰됩니다. 허리 척추주위근육(Paraspinal muscle)은 급성 신경뿌리 압박 통증으로 인해 수의수축 동원 평가가 불가능합니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "온종아리신경병증(Common peroneal neuropathy)은 가쪽 무릎 부위 포착으로 얕은종아리신경 SNAP 및 Peroneal CMAP가 대폭 감소(정상측 대비 50% 이하)하며, 위볼기신경지배인 중간볼기근 및 척추주위근은 완벽히 정상입니다.",
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 앞정강근(TA)과 긴종아리근(PL)의 침근전도 소견 상 섬유자발전위(Fibrillation), 양성예파(Positive sharp wave)의 비정상 탈신경 자발 활동이 관찰됩니다. 석고 캐스트 장기 고정으로 비골두 가측 부위의 온종아리신경이 직접 압박을 받아 먼쪽(distal) 운동축삭 변성이 야기되었음을 가리킵니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 앞정강근, 긴종아리근의 수의수축 시 운동단위동원 감소(Reduced MU recruitment) 패턴이 나타나 운동단위 결손을 대변합니다. 반면 허리 척추주위근(Paraspinal)은 휴식 시 Silent at rest, 수의수축 시 Normal MU recruitment로 매우 조용하여 신경뿌리병증을 완벽히 배제합니다."
            ],
            "integration": [
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "장딴지신경 감각신경활동전위, 넓적다리신경 및 종아리신경 복합근육활동전위 등 복수의 주요 말초 전도에서 진폭 감소가 확인됩니다. 이는 병변이 척수뒤뿌리신경절 먼쪽(distal)에 형성된 말초 신경얼기 줄기 장애임을 시사합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 가쪽넓은근(Vastus lateralis)과 앞정강근(TA) 침근전도 검사에서, 휴식 시 섬유자발전위(Fibrillation) 및 양성예파(Positive sharp wave)의 탈신경 자발 활동전위가 매우 명확히 관찰되어, 골반 외상에 수반된 운동축삭 손상 상황을 대변합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 가쪽넓은근과 앞정강근에서 감소된 운동단위동원(Reduced MU recruitment) 패턴 현상이 도출됩니다. 반면 허리 척추주위근(Paraspinal)은 휴식 시 전기적 침묵(Silent at rest), 수의수축 시 운동단위동원(Normal MU recruitment)으로 정상을 보여 다발 신경뿌리가 아닌 신경얼기(Plexus) 수준의 파열 손상임을 생리학적으로 확립시킵니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "다발 허리 신경뿌리병증(Lumbar radiculopathy)은 감각신경전도가 정상 범위로 유지되며, 요배부 척추주위근 침근전도에서 다발성 탈신경 활동이 매우 명확하게 나타납니다.",
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "장기 당뇨병 병력, 대칭성 먼쪽(distal) 장갑-양말 감각 저하, 아킬레스 반사 소실 및 다리 감각신경활동전위/복합근육활동전위 진폭 감소를 연결하여 최종 확진합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 앞정강근(TA) 근육의 수의수축 시 정상적인 운동단위동원(Normal MU recruitment) 양상이 나타납니다. 축삭 단절에 의한 지배 유실이 없으므로 수의수축 시 간섭파형 동원은 완벽히 유발 보존되고 있음을 지시합니다."
            ],
            "integration": [
                "근위/먼쪽(distal) 동시 마비, 전신 무반사, 다발성 잠복기 지연 및 F파 지연 소실을 종합하여 만성 염증성 말이집탈락성 다발신경병증으로 판단합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 검사 선택의 전기생리학적 근거:",
                "본 사례는 삼차-얼굴신경 반사궁 회로(Blink reflex)의 회로 전도 결손만을 정밀 평가하는 증례로, 먼쪽(distal) 운동 단절이나 변성이 수반되지 않아 침근전도(Needle EMG) 검사는 임상 프로토콜 상 전면 제외되었습니다."
            ],
            "integration": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "말초 신경 손상(Radiculopathy) 시에는 H-반사의 지연 및 유발 소실이 수반되지만, 중추성 마비에 의한 경직 시에는 H-반사 진폭이 크게 항진되고 H/M 비율이 정상보다 증가합니다.",
                "practical_tip": "H/M 비율의 양적 감소 수치는 중추성 신경 손상 환자의 물리치료적 경직 중재 수준을 평가하는 정량적인 근거로 활용될 수 있습니다."
            }
        ]
    }
} # <--- CASE_LIBRARY 전체 딕셔너리를 정상적으로 파싱 마감하는 엠버 가이딩 중괄호 (오류 완벽 차단)
