...
CASE_LIBRARY = {
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "2) 수의수축 시 운동단위 동원 분석:",
                "수의수축 시 노쪽손목폄근(ECR)과 집게폄근(EIP)에서 감소된 운동단위동원(Reduced MU recruitment) 패턴 반응이 나타나 폄근 마비를 대변합니다. 반면 목 뒤가지 경로를 대변하는 목 척추주위근은 휴식 시 전기적 침묵(Silent at rest), 수의수축 시 운동단위동원(Normal MU recruitment)으로 매우 조용하여 신경뿌리병증을 배제합니다."
            ],
            "integration": [
    ...
    "4, 5번째 손가림과 손가락 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "자신경 감각신경활동전위(SNAP)의 잠복기 지연은 주관증후군 내 말이집탈락성 수축 변화를 시사하며, 복합근육활동전위(CMAP)의 진폭 저하(50% 미만)는 축삭성 마비가 개입되었음을 의미합니다."
            ],
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "새끼벌림근(ADM) 및 첫째등쪽뼈사이근(FDI)에서 휴식 시 섬유자발전위(fbrillation) 및 양성예파(positive sharp wave)의 탈신경 자발전위가 도출됩니다. 이는 팔꿈치 터널 내부 포착으로 인해 운동 축삭 전도의 기계적 손상이 유발되었음을 시사합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "온종아리신경병증은 가쪽 무릎 부위 포착으로 얕은종아리신경 감각신경활동전위 및 종아리신경 복합근육활동전위가 대폭 감소하며, 위볼기신경지배인 중간볼기근 및 척추주위근은 완벽히 정상입니다.",
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 앞정강근, 긴종아리근의 수의수축 시 운동단위동원 감소(Reduced MU recruitment) 패턴이 나타나 운동단위 결손을 대변합니다. 반면 허리 척추주위근(Paraspinal)은 휴식 시 전기적 침묵(Silent at rest), 수의수축 시 운동단위동원(Normal MU recruitment)으로 매우 조용하여 신경뿌리병증을 완벽히 배제합니다."
            ],
            "integration": [
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "좌측 가쪽넓은근(Vastus lateralis)과 앞정강근(TA) 침근전도 검사에서, 휴식 시 섬유자발전위(fbrillation) 및 양성예파(positive sharp wave)의 탈신경 자발 활동전위가 매우 명확히 관찰되어, 골반 외상에 수반된 운동축삭 손상 상황을 대변합니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "양측 앞정강근(TA)의 침근전도 결과, 휴식 시 섬유자발전위(fbrillation) 및 양성예파(positive sharp wave)의 탈신경 비정상 자발전위가 좌우 대칭 분포로 유도됩니다. 대사성 축삭 병변으로 인해 긴 말단 축삭 가지부터 대칭 손상해 들어오는 Dying back 기전의 세포학적 단서입니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
