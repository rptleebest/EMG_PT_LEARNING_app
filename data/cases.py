...
(정상측 표시 정상 범위로 수정, 병변측 진폭/잠복기 구분 출력, 이학적 검사 한글/영어 명칭 표준화 반영)
"""
...
CASE_LIBRARY = {
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "새끼손가락 벌림: Fair (3/5) - 새끼벌림근(Abductor digiti minimi) - 자신경(Ulnar nerve) [T1 우세]",
                    "손가락 벌림/모음: Fair (3/5) - 뼈사이근(Interossei) - 자신경(Ulnar nerve) [T1 우세]"
                ],
                "반사 검사": [
                    "위팔두갈래근(C5), 위팔노근(C6), 위팔세갈래근(C7) 반사: 대칭적 정상(DRT 2+)",
                    "특수 검사: 팔꿉관절 굽힘 검사 양성(Elbow flexion test positive sign), 팔꿈치 자쪽 티넬징후 양성(Elbow ulnar Tinel positive sign)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "자신경 감각신경활동전위(SNAP)에서 잠복기 지연이 나타나 팔꿈치 부위 국소 포착성 전도 지연을 시사합니다.",
                "자신경 복합근육활동전위(CMAP) 진폭 감소는 포착이 진행되어 운동축삭 손상이 동반되었을 가능성을 시사합니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                "자신경 감각 영역 저림, 손 자체기원근 약화, 자신경 감각신경활동전위 지연, 자신경 복합근육활동전위 진폭 감소, 자신경 지배근 탈신경 소견을 종합하면 팔꿈치 부위 자신경병증이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    ...
                    "엄지발가락 폄: Poor (2/5) - 긴엄지폄근(Extensor hallucis longus) - 깊은종아리신경(Deep peroneal nerve) [L5 우세]",
                    "엉덩관절 벌림: Good (4/5) - 중간볼기근(Gluteus medius) - 위볼기신경(Superior gluteal nerve) [L5 우세]"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "종아리신경 CMAP가 정상 범위이므로 온종아리신경병증보다는 L5 신경뿌리병증을 우선 고려합니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                "L5 방사통, L5 우세 근력 약화, SNAP 보존, 척추주위근 침범을 종합하면 L5 허리 신경뿌리병증이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "온종아리신경병증(Common peroneal neuropathy)",
                "why_consider": "발목관절 등굽힘 약화와 발처짐이 공통적으로 나타납니다.",
                "how_to_differentiate": "온종아리신경병증에서는 얕은종아리신경 SNAP 감소, 종아리신경 CMAP 감소가 흔하며 중간볼기근 and 척추주위근은 정상이어야 합니다.",
                "practical_tip": "발처짐 환자는 엉덩관절 벌림과 발목관절 안쪽번짐을 함께 평가하여 L5 신경뿌리병증과 종아리신경병증을 구분하세요."
            }
        ]
    },
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    ...
                    "엄지발가락 폄: Trace (1/5) - 긴엄지폄근(Extensor hallucis longus) - 깊은종아리신경(Deep peroneal nerve) [L5 우세]",
                    "발목관절 가쪽번짐: Poor (2/5) - 긴종아리근(Peroneus longus) - 얕은종아리신경(Superficial peroneal nerve) [L5 우세]",
                    "발목관절 안쪽번짐: Normal (5/5) - 뒤정강근(Tibialis posterior) - 정강신경(Tibial nerve) [L5 지배 보존]"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "얕은종아리신경 SNAP 진폭 감소는 말초 감각신경 손상을 의미합니다.",
                "종아리신경 CMAP 진폭 감소는 운동축삭 손상 또는 심한 압박성 전도장애를 시사합니다."
            ],
            "emg_reason": [
            ...
            "integration": [
                "석고붕대 압박 병력, 종아리신경 지배근 약화, 발목관절 안쪽번짐 보존, 감각신경활동전위(SNAP)/복합근육활동전위(CMAP) 감소를 종합하면 온종아리신경병증이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "L5 신경뿌리병증은 감각신경활동전위(SNAP)가 보존되고 척추주위근 침범이 나타날 수 있습니다. 본 사례는 SNAP 감소와 척추주위근 정상 소견이 핵심입니다.",
                "practical_tip": "발처짐에서 발목 안쪽번짐이 정상이라면 종아리신경병증 가능성을 가차없이 고려하세요."
            }
        ]
    },
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "장딴지신경 SNAP, 종아리신경 CMAP, 넓적다리신경 CMAP 등 여러 말초신경에서 진폭 감소가 관찰됩니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "다발 신경뿌리병증은 SNAP가 보존되고 척추주위근 이상이 동반되는 경우가 많습니다. 본 사례는 SNAP 감소와 척추주위근 보존이 핵심입니다.",
                "practical_tip": "광범위 다리 약화에서는 SNAP와 척추주위근 침범 여부가 신경뿌리와 신경얼기 감별에 중요합니다."
            }
        ]
    },
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "양측 엄지발가락 폄: Good (4/5) - 긴엄지폄근(Extensor hallucis longus) - 깊은종아리신경(Deep peroneal nerve) [L5 우세]",
                    "양측 발가락 굽힘: Good (4/5) - 긴발가락굽힘근(Flexor digitorum longus) - 정강신경(Tibial nerve) [S1 우세]",
                    "양측 발목관절 등굽힘: Normal (5/5) - 앞정강근(Tibialis anterior) - 깊은종아리신경(Deep peroneal nerve) [L4-L5 우세]",
                    "양측 무릎관절 폄: Normal (5/5) - 넙다리네갈래근(Quadriceps femoris) - 넓적다리신경(Femoral nerve) [L3-L4 우세]",
                    "양측 엉덩관절 굽힘: Normal (5/5) - 엉덩허리근(Iliopsoas) - 요신경얼기/넓적다리신경 관련 [L2 우세]"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "진행된 경우 원위부 근육 침근전도에서 섬유자발전위와 양성예파가 추가로 관찰될 수 있습니다."
            ],
            "integration": [
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "양측 어깨관절 벌림: Fair (3/5) - 어깨세모근(Deltoid) - 겨드랑신경(Axillary nerve) [C5 우세]",
                    "양측 엉덩관절 굽힘: Fair (3/5) - 엉덩허리근(Iliopsoas) - 요신경얼기/넓적다리신경 관련 [L2 우세]",
                    "양측 손목관절 폄: Fair (3/5) - 노쪽손목폄근(Extensor carpi radialis) - 노신경(Radial nerve) [C6 우세]",
                    "양측 발목관절 등굽힘: Fair (3/5) - 앞정강근(Tibialis anterior) - 깊은종아리신경(Deep peroneal nerve) [L4-L5 우세]"
                ],
                "반사 검사": [
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "근육병증은 감각 이상이 없고 깊은힘줄반사가 상대적으로 보존되는 경우가 많습니다. 본 사례는 감각 이상과 전반적 반사 소실이 있어 신경병증에 가깝습니다.",
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "patient": {
            ...
            "physical_exam": {
                "감각 검사": [
                    "우측 이마 및 눈 주위, 즉 삼차신경 눈신경(V1) 영역의 가벼운 터치 감각 둔화"
                ],
                "맨손 근력검사(MMT)": [
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                ...
                "얼굴신경병증이 의심될 때는 얼굴근육 침근전도에서 섬유자발전위, 양성예파, 운동단위전위 동원 감소 등을 추가로 확인할 수 있습니다."
            ],
            "integration": [
                "우측 V1 감각저하와 우측 자극 시 양측 반응 이상이 일치하므로 우측 삼차신경 들신경 경로 이상으로 해석합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "practical_tip": "눈깜빡반사는 자극측 문제인지, 반응측 문제인지 나누어 해석하는 것이 핵심입니다."
            }
        ]
    },
    ...
    "뇌졸중 후 발목 발바닥굽힘근 경직 평가": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "발목관절 등굽힘: Poor (2/5) - 앞정강근(Tibialis anterior) - 깊은종아리신경(Deep peroneal nerve) [L4-L5 우세]",
                    "발목관절 발바닥굽힘: Poor (2/5) - 장딴지근(Gastrocnemius) - 정강신경(Tibial nerve) [S1 우세]",
                    "근긴장도: 발목 발바닥굽힘근 수정 애쉬워스 척도(MAS) 3등급"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            "summary": "위운동신경세포(upper motor neuron, UMN) 손상에 따른 척수반사 흥분성 증가를 전기생리적으로 확인하는 사례입니다.",
            "ncs_reason": [
                "정강신경 CMAP가 정상 범위이면 말초 운동신경-근육 경로 자체는 보존된 것으로 볼 수 있습니다.",
                "말초 신경 손상보다는 중추성 조절 저하로 인한 반사 회로 과흥분을 고려합니다."
            ],
            "emg_reason": [
                "H-반사가 낮은 자극 강도에서 쉽게 유발되거나 H/M 비율이 증가하면 척수반사 흥분성 증가를 시사합니다.",
                "이 사례는 침근전도 탈신경보다 반사 생리 평가가 핵심입니다."
            ],
            "integration": [
                "뇌졸중 병력, MAS 3등급 경직, 아킬레스힘줄반사 항진, 발목간대경련, H-반사 항진이 일치하므로 중추성 경직 평가 사례로 해석합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "말초 S1 신경뿌리병증(Peripheral S1 radiculopathy)",
                "why_consider": "H-반사는 S1 신경뿌리 평가에도 사용됩니다.",
                "how_to_differentiate": "S1 신경뿌리병증에서는 H-반사 지연 또는 소실과 반사 저하가 흔합니다. 본 사례는 반사 항진과 H/M 비율 증가가 핵심이므로 UMN 병변에 가깝습니다.",
                "practical_tip": "H-반사는 말초 병변에서는 지연/소실, 중추성 경직에서는 항진될 수 있음을 구분하세요."
            }
        ]
    },
    ...
    "급성 양측 다리 근력 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                "발병 초기에는 원위부 CMAP와 SNAP가 정상 범위일 수 있습니다.",
                "F파 지연 또는 소실은 근위부 운동신경, 신경뿌리, 초기 말이집탈락성 변화를 보여주는 중요한 단서입니다."
            ],
            "emg_reason": [
                "급성기에는 왈러변성(Wallerian degeneration)이 충분히 진행되지 않아 침근전도에서 섬유자발전위나 양성예파가 아직 보이지 않을 수 있습니다.",
                "따라서 초기 GBS에서는 침근전도보다 F파와 임상 반사 소실이 더 중요한 단서가 될 수 있습니다."
            ],
            "integration": [
                "선행 감염, 급성 상행성 이완성 근력저하, 양측 깊은힘줄반사 소실, F파 지연 또는 소실을 종합하면 초기 GBS를 우선 고려합니다."
            ]
        },
        "differential_diagnosis": [
            {
    ...
    "아침 기상 시 손목처짐이 갑자기 생긴 경우": {
        ...
        "teaching_diagnosis": {
            "summary": "압박성 노신경병증(saturday night palsy) 패턴입니다.",
            "ncs_reason": [
                "표재노신경 SNAP 감소는 말초 감각신경 침범을 의미합니다.",
                "노신경 CMAP 감소는 압박에 의한 운동축삭 손상 가능성을 시사합니다."
            ],
            "emg_reason": [
                "노신경 지배 원위부 근육에서 비정상 자발전위(fibrillation, positive sharp wave, fasciculation 등)가 나타나면 축삭 손상이 동반된 압박성 병변으로 해석할 수 있습니다.",
                "척추주위근이 정상이므로 경추 신경뿌리병증보다 말초 노신경병증이 더 적절합니다."
            ],
            "integration": [
                "수면 자세 관련 압박 병력과 손목처짐, 표재노신경 감각 이상, CMAP/SNAP 감소를 종합하면 압박성 노신경병증이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "C7 목 신경뿌리병증",
                "why_consider": "손가락 폄 약화가 유사할 수 있습니다.",
                "how_to_differentiate": "신경뿌리병증은 SNAP 보존과 척추주위근 침범이 도움이 됩니다. 본 사례는 SNAP 감소와 척추주위근 정상입니다.",
                "practical_tip": "압박 병력이 뚜렷하면 말초 노신경병증을 우선 의심하되, 척추주위근과 SNAP를 함께 보세요."
            }
        ]
    },
    ...
    "엉덩이 주사 후 종아리 뒤가쪽 통증과 발바닥굽힘 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                "감각 검사": [
                    "허벅지 뒤가쪽, 종아리 뒤쪽, 발바닥 바깥쪽 감각 저하. 좌골신경(sciatic nerve) 및 S1 피부분절과 연관"
                ],
                "맨손 근력검사(MMT)": [
                    "무릎관절 굽힘: Fair (3/5) - 넙다리뒤근(Hamstrings) - 좌골신경(Sciatic nerve) [L5-S1 우세]",
                    "발목관절 발바닥굽힘: Poor (2/5) - 장딴지근(Gastrocnemius) - 정강신경(Tibial nerve) [S1 우세]",
                ...
                "반사 검사": [
                    "아킬레스힘줄반사(Achilles reflex, S1): 우측 감소 또는 소실(DTR 1+/0)",
                    "무릎반사(Patellar reflex, L4): 대칭적 정상(DTR 2+)"
                ]
            }
        },
        "findings": {
        ...
        "teaching_diagnosis": {
            "summary": "엉덩이 주사 후 발생한 좌골신경병증(sciatic neuropathy) 또는 S1 중심 말초신경 손상 패턴입니다.",
            "ncs_reason": [
                "장딴지신경(sural nerve) 감각신경활동전위(SNAP) 감소는 뒤뿌리신경절보다 먼쪽 감각신경 침범을 시사합니다.",
                "정강신경 복합근육활동전위(CMAP) 감소는 S1 지배 운동축삭 손상을 시사합니다.",
                "종아리신경 복합근육활동전위(CMAP)가 상대적으로 보존되면 병변이 좌골신경의 분지 중 정강신경 쪽 또는 S1 우세 침범일 가능성을 고려할 수 있습니다."
            ],
            "emg_reason": [
                "무릎관절 굽힘과 발목관절 발바닥굽힘에 관여하는 근육에서 탈신경근 소견이 관찰되면 좌골신경 또는 S1 지배 운동섬유 침범을 시사합니다.",
                "척추주위근이 보존되면 S1 신경뿌리병증보다는 말초 좌골신경병증 가능성이 높습니다."
            ],
            "integration": [
                "엉덩이 주사 후 발생, 허벅지 뒤가쪽-종아리 뒤쪽 통증, 무릎 굽힘 및 발목 발바닥굽힘 약화, 아킬레스힘줄반사 저하를 종합하면 좌골신경병증 또는 S1 우세 말초신경 손상이 적절합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "S1 허리 신경뿌리병증(S1 lumbar radiculopathy)",
                "why_consider": "허벅지 뒤가쪽 통증, 발목관절 발바닥굽힘 약화, 아킬레스힘줄반사 저하가 공통적으로 나타날 수 있습니다.",
                "how_to_differentiate": "신경뿌리병증은 장딴지신경 SNAP가 보존되는 경우가 많고, 척추주위근 이상이 동반될 수 있습니다. 본 사례는 주사 후 발생 병력과 말초신경 전도 이상이 핵심입니다.",
                "practical_tip": "엉덩이 주사 후 발생한 하지 약화는 S1 신경뿌리병증보다 좌골신경병증을 먼저 떠올리되, SNAP와 척추주위근 소견으로 구분하세요."
            }
        ]
    },
    ...
    "원위부 손가락 근력 약화와 근육다발수축": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손 근력검사(MMT)": [
                    "손가락 벌림/모음: Fair (3/5) - 뼈사이근(Interossei) - 자신경(Ulnar nerve) [T1 우세]",
                    "엄지손가락 벌림: Fair (3/5) - 짧은엄지벌림근(Abductor pollicis brevis) - 정중신경(Median nerve) [T1 우세]",
                    "손목관절 폄: Good (4/5) - 노쪽손목폄근(Extensor carpi radialis) - 노신경(Radial nerve) [C6 우세]"
                ],
                "반사 검사": [
                    "상지 반사는 정상이거나 항진될 수 있음",
                    "병적반사 동반 여부 확인 필요"
                ]
            }
        },
        ...
        "teaching_diagnosis": {
            "summary": "운동신경세포질환 또는 광범위 전각세포 병변을 의심하게 하는 교육용 사례입니다.",
            "ncs_reason": [
                "감각신경전도가 비교적 보존되면서 운동계 증상이 두드러지면 운동신경세포 수준 병변을 고려할 수 있습니다.",
                "단일 포착신경병증으로 설명하기 어려운 여러 손근육 침범 양상이 특징입니다."
            ],
            "emg_reason": [
                "근육다발수축전위(fasciculation potential)와 탈신경근 소견이 함께 나타나면 운동신경세포질환 감별에 중요합니다.",
                "서로 다른 말초신경 지배 손근육에서 이상이 나타나면 국소 포착만으로 설명하기 어렵습니다."
            ],
            "integration": [
                "감각 보존, 진행성 손근 위약, 근육다발수축, 다신경 지배 손근육 침범을 종합하면 운동신경세포질환을 감별에 포함해야 합니다."
            ]
        },
        "differential_diagnosis": [
            {
                "name": "다발 포착신경병증(Multiple entrapment neuropathies)",
                "why_consider": "정중/자신경 지배 손근육 약화가 혼재되어 보일 수 있습니다.",
                "how_to_differentiate": "포착신경병증은 보통 해당 감각신경전도 이상이 동반되지만 본 사례는 감각 보존이 두드러집니다.",
                "practical_tip": "감각이 정상인데 운동 이상이 넓게 퍼져 있으면 운동신경세포질환 가능성을 떠올리세요."
            }
        ]
    }
}
