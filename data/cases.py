    ...
    "목-팔 통증 증상과 팔 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "팔꿉관절 굽힘근: Fair (3/5) | 근육피부신경(C5-C6)",
                    "손목관절 폄근: Fair (3/5) | 노신경(C6-C7)",
                    "팔꿉관절 폄근: Normal (5/5) | 노신경(C7-C8)"
                ],
    ...
    "위팔뼈 몸통 골절 후 손목처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "손목관절 폄근: Poor (2/5) | 노신경(C6-C7)",
                    "손가락 폄근: Poor (2/5) | 노신경(C7-C8)",
                    "팔꿉관절 폄근: Normal (5/5) | 노신경(C7-C8)"
                ],
    ...
    "허리-다리 통증과 발처짐": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목관절 등굽힘근: Fair (3/5) | 깊은종아리신경(L4-L5)",
    ...
    "정강뼈 골절로 석고붕대 후 발처짐과 발등 감각저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "발목 등굽힘근: Poor (2/5) | 깊은종아리신경(L4-L5)",
                    "발목 가쪽번짐근: Poor (2/5) | 얕은종아리신경(L5-S1)",
                    "발목 안쪽번짐근: Normal (5/5) | 정강신경(L4-L5)"
                ],
    ...
    "골반 외상 후 다리 전반 근력 약화": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "엉덩관절 굽힘근: Poor (2/5) | 넙다리신경(L2-L4)",
                    "무릎관절 폄근: Poor (2/5) | 넙다리신경(L2-L4)",
                    "발목 등굽힘근: Trace (1/5) | 깊은종아리신경(L4-L5)"
                ],
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    ...
                    "양측 엄지발가락 굽힘근: Good (4/5) | 정강신경(S1-S2)"
                ],
    ...
    "대칭성 팔다리 근력저하와 보행 저하": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "맨손근력검사(MMT)": [
                    "양측 어깨 벌림근: Fair (3/5) | 겨드랑신경(C5-C6)",
                    "양측 손목 폄근: Fair (3/5) | 노신경(C6-C7)",
                    "양측 발목 등굽힘근: Fair (3/5) | 깊은종아리신경(L4-L5)"
                ],
