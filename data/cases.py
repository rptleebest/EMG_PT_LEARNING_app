...
CASE_LIBRARY = {
    ...
    "4, 5번째 손가락 저림과 손가락 근력 약화": {
        ...
        "teaching_diagnosis": {
            "ncs_reason": [
                "자신경 감각신경 잠복기 지연이 나타나며, 운동신경 전도검사에서 팔꿈치 아래 자극에 비해 '팔꿈치 위' 자극 시 진폭이 급감하는 국소 전도차단이 명확히 관찰됩니다.",
        ...
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "목 신경뿌리병증은 자신경뿐 아니라 정중신경 근육도 동시 침범되며, 말초 감각신경 전도는 몸쪽 병변이므로 정상으로 보존되어야 합니다."
            }
        ]
    },
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "본 사례는 먼쪽 운동 단절이 수반되지 않은 순수 반사궁 들신경 전도 결손 사례이므로 침근전도는 실시되지 않았습니다."
            ],
            "integration": [
