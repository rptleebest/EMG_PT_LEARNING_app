...
CASE_LIBRARY = {
    ...
    "양측 발끝 저림과 발가락 약화": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 휴식 시 자발활동 전기생리 판독:",
                "양측 앞정강근(TA)의 바늘 침전위 결과, 휴식 시 fibrillation potential 및 positive sharp wave의 이상 탈신경 활동이 좌우 대칭 분포로 유도됩니다. 대사성 축삭 병변으로 인해 긴 말단 축삭 가지부터 대칭 사멸해 들어오는 Dying back 기전의 세포학적 단서입니다.",
                "2) 수의수축 시 운동단위 동원 분석:",
                "해당 TA 근육들의 수의수축 시, 운동단위 소실 및 잔여 축삭 발아(Sprouting)에 기초하여 Giant MUAPs 출현 및 Reduced MU recruitment 양상이 좌우 대칭적으로 발생하여 만성 축삭 파괴 상태를 지지합니다."
            ],
            "integration": [
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "patient": {
            ...
            "physical_exam": {
                ...
                "뇌신경 감각 검사": [
                    "우측 이마 및 눈 주변 영역(삼차신경 눈 신경 V1 가지)의 촉각 감각 감소"
                ],
                "반사 검사": [
        ...
        "teaching_diagnosis": {
            "summary": "우측 삼차신경(Trigeminal nerve, 눈 신경 V1 가지)의 들신경 경로(Afferent limb) 손상입니다.",
            "ncs_reason": [
                ...
                "이는 얼굴마비를 일으키는 얼굴신경(날신경 경로)은 정상이나, 자극을 수용하여 뇌줄기로 보내는 삼차신경(들신경 경로)의 우측 분지에 전도 장애가 발생했음을 생리학적으로 확증합니다."
            ],
            "emg_reason": [
                "1) 검사 선택의 전기생리학적 근거:",
            ...
            "integration": [
                "우측 삼차신경 지배 분지의 촉각 저하, 우측 각막반사 감소 및 우측 자극 시 양측 수축 반응의 전기적 지연 소실을 종합하여 우측 삼차신경(Afferent limb) 전도 장애로 최종 판독합니다."
            ]
        },
        "differential_diagnosis": [
            {
                ...
                "how_to_differentiate": "우측 얼굴신경(날신경) 병변이라면 좌측 자극 시에도 우측 반응인 우측 R2가 소실되어야 하지만, 본 환자는 좌측 자극 시 우측 R2가 정상입니다.",
                "practical_tip": "Blink reflex 판독 시 자극을 준 쪽이 문제인지(Afferent), 반응을 하는 눈꺼풀 근육 쪽이 문제인지(Efferent) 매트릭스를 대조하십시오."
            }
        ]
    },
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "patient": {
            ...
            "side": "오른쪽",
            "symptoms": [
                "뇌졸중 후 편마비(Hemiplegia) 상태이며 우측 발목 발바닥굽힘근의 중증 경직 발생",
                "발꿈치안쪽휜들린발(Equinovarus)로 보행에 극심한 지장을 받아, 물리치료 전/후 경직 완화 효과를 정량적으로 모니터링함"
            ],
            "physical_exam": {
                "근긴장도 검사 (MAS)": [
                    "우측 발목 발바닥굽힘근 수정 애쉬워스 척도(MAS): 3등급 (물리치료 적용 전)",
                    "우측 발목 발바닥굽힘근 수정 애쉬워스 척도(MAS): 1+등급 (물리치료 적용 후)"
                ],
                "깊은힘줄 및 병적반사 검사": [
        ...
        "teaching_diagnosis": {
            ...
            "ncs_reason": [
                ...
                "스트레칭 및 대항근(앞정강근) 기능적 전기자극(FES) 적용 후, H/M ratio가 55%로 소폭 감소하여 척수 반사회로의 과흥분성이 일부 완화된 것으로 평가됩니다."
            ],
            "emg_reason": [
                "1) 치료 효과 검증을 위한 H-반사 단독 평가:",
                "본 사례는 편마비 환자의 경직(Spasticity) 정량적 중재 평가를 목적으로 후기반응인 H-reflex만을 단독 추적 관찰했습니다."
            ],
            "integration": [
