...
CASE_LIBRARY = {
    ...
    "눈꺼풀 떨림과 눈 주위 불편감 지속": {
        ...
        "teaching_diagnosis": {
            ...
            "emg_reason": [
                "1) 검사 선택의 전기생리학적 근거:",
                "본 사례는 삼차-얼굴신경 반사궁 회로(Blink reflex)의 회로 전도 결손만을 정밀 평가하는 증례로, 먼쪽(Distal) 운동 단절이나 변성이 수반되지 않아 침근전도검사(Needle EMG)는 핵심 판독 대상에서 제외됩니다.",
            ],
            "integration": [
    ...
    "뇌졸중 환자 발목 경직 평가": {
        ...
        "teaching_diagnosis": {
            ...
            "integration": [
                "MAS 3등급의 보행 제한 환자에게 물리치료를 적용한 후, H-반사의 진폭 감소 및 H/M 비율의 정량적 회복(65%에서 55%)을 통해 위운동신경세포(UMN) 증후군 환자의 소폭 경직 완화 물리치료 효과가 나타난 임상 사례입니다.",
            ],
        },
        "differential_diagnosis": [
            {
                "name": "말초 S1 신경뿌리병증",
                "why_consider": "아킬레스힘줄반사와 S1 반사 경로를 공유하므로 유사하게 해석될 여지가 있습니다.",
